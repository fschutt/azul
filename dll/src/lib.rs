...
#[no_mangle] pub extern "C" fn AzApp_new(data: AzRefAny, config: AzAppConfig) -> AzApp { azul_core::app::AzAppPtr::new(data, config) }
...
#[no_mangle] pub extern "C" fn AzCallbackInfo_shapeText(callbackinfo: &AzCallbackInfo, node_id: AzDomNodeId, text: AzString) -> AzOptionInlineText { azul_core::text_layout::callback_info_shape_text(callbackinfo, node_id, text).into() }
...
#[no_mangle] pub extern "C" fn AzStyledDom_fromXml(xml_string: AzString) -> AzStyledDom { azul_core::app::extra::styled_dom_from_str(xml_string.as_str()) }
/// Same as `from_xml`, but loads the file relative to the current directory
#[no_mangle] pub extern "C" fn AzStyledDom_fromFile(xml_file_path: AzString) -> AzStyledDom { azul_core::app::extra::styled_dom_from_file(xml_file_path.as_str()) }
...
#[no_mangle] pub extern "C" fn AzFontRef_getFontMetrics(fontref: &AzFontRef) -> AzFontMetrics { azul_core::text_layout::get_font_metrics_fontref(fontref) }
/// Returns the text layout of the shaped text
#[no_mangle] pub extern "C" fn AzFontRef_shapeText(fontref: &AzFontRef, text: AzRefstr, options: AzResolvedTextLayoutOptions) -> AzInlineText { azul_core::text_layout::shape_text(fontref, text.as_str(), &options) }
...
#[no_mangle] pub extern "C" fn AzXml_fromStr(xml_string: AzRefstr) -> AzResultXmlXmlError { azul_core::xml::parse_xml(xml_string.as_str()).into() }
