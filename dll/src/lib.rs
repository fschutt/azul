...
#[no_mangle] pub extern "C" fn AzApp_new(data: AzRefAny, config: AzAppConfig) -> AzApp { crate::azul_impl::app::AzAppPtr::new(data, config) }
...
#[no_mangle] pub extern "C" fn AzCallbackInfo_shapeText(callbackinfo: &AzCallbackInfo, node_id: AzDomNodeId, text: AzString) -> AzOptionInlineText { azul_layout::callback_info_shape_text(callbackinfo, node_id, text).into() }
...
#[no_mangle] pub extern "C" fn AzDom_getHtmlString(dom: &mut AzDom) -> AzString { dom.style(AzCss::empty().into()).get_html_string("", "", false).into() }
/// Returns a HTML for unit testing
#[no_mangle] pub extern "C" fn AzDom_getHtmlStringTest(dom: &mut AzDom) -> AzString { dom.style(AzCss::empty().into()).get_html_string("", "", true).into() }
...
#[no_mangle] pub extern "C" fn AzColorU_fromStr(string: AzString) -> AzColorU { azul_css::parser::parse_css_color(string.as_str()).ok().unwrap_or(AzColorU::BLACK) }
/// Creates a new `ColorU` instance whose memory is owned by the rust allocator
...
#[no_mangle] pub extern "C" fn AzStyledDom_new(dom: AzDom, css: AzCss) -> AzStyledDom { let mut dom = dom; AzStyledDom::new(&mut dom, css.into()) }
...
#[no_mangle] pub extern "C" fn AzStyledDom_fromXml(xml_string: AzString) -> AzStyledDom { crate::extra::styled_dom_from_str(xml_string.as_str()) }
/// Same as `from_xml`, but loads the file relative to the current directory
#[no_mangle] pub extern "C" fn AzStyledDom_fromFile(xml_file_path: AzString) -> AzStyledDom { crate::extra::styled_dom_from_file(xml_file_path.as_str()) }
...
/// Allocates an OpenGL texture of a given size with a single red channel (used for image masks)
#[no_mangle] pub extern "C" fn AzTexture_allocateClipMask(gl: AzGl, size: AzPhysicalSizeU32, background: AzColorU) -> AzTexture { azul_layout::xml::svg::allocate_clipmask_texture(gl, size, background) }
...
#[no_mangle] pub extern "C" fn AzRawImage_decodeImageBytesAny(bytes: AzU8VecRef) -> AzResultRawImageDecodeImageError { azul_layout::image::decode::decode_raw_image_from_any_bytes(bytes.as_slice()) }
...
#[no_mangle] pub extern "C" fn AzFontRef_parse(source: AzFontSource) -> AzOptionFontRef { azul_layout::parse_font_fn(source).into() }
...
#[no_mangle] pub extern "C" fn AzXml_fromStr(xml_string: AzRefstr) -> AzResultXmlXmlError { azul_layout::xml::parse_xml(xml_string.as_str()).into() }
...
mod test_sizes {
    ...
    fn test_size() {
        ...
        assert_eq!((Layout::new::<crate::azul_impl::app::AzAppPtr>(), "AzApp"), (Layout::new::<AzApp>(), "AzApp"));
        ...
        assert_eq!((Layout::new::<azul_core::callbacks::Callback>(), "AzCallback"), (Layout::new::<AzCallback>(), "AzCallback"));
        ...
        assert_eq!((Layout::new::<azul_core::styled_dom::NodeHierarchyItemId>(), "AzNodeId"), (Layout::new::<AzNodeId>(), "AzNodeId"));
        assert_eq!((Layout::new::<azul_core::styled_dom::DomId>(), "AzDomId"), (Layout::new::<AzDomId>(), "AzDomId"));
        ...
        assert_eq!((Layout::new::<azul_core::callbacks::RenderImageCallback>(), "AzRenderImageCallback"), (Layout::new::<AzRenderImageCallback>(), "AzRenderImageCallback"));
        ...
        assert_eq!((Layout::new::<azul_core::styled_dom::AzTagId>(), "AzTagId"), (Layout::new::<AzTagId>(), "AzTagId"));
        assert_eq!((Layout::new::<azul_core::styled_dom::CssPropertyCachePtr>(), "AzCssPropertyCache"), (Layout::new::<AzCssPropertyCache>(), "AzCssPropertyCache"));
        ...
        assert_eq!((Layout::new::<azul_core::gl::AzGlType>(), "AzGlType"), (Layout::new::<AzGlType>(), "AzGlType"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgCircle>(), "AzSvgCircle"), (Layout::new::<AzSvgCircle>(), "AzSvgCircle"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgColoredVertex>(), "AzSvgColoredVertex"), (Layout::new::<AzSvgColoredVertex>(), "AzSvgColoredVertex"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgVertex>(), "AzSvgVertex"), (Layout::new::<AzSvgVertex>(), "AzSvgVertex"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgRenderTransform>(), "AzSvgRenderTransform"), (Layout::new::<AzSvgRenderTransform>(), "AzSvgRenderTransform"));
        assert_eq!((Layout::new::<azul_core::svg::Indent>(), "AzIndent"), (Layout::new::<AzIndent>(), "AzIndent"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgFitTo>(), "AzSvgFitTo"), (Layout::new::<AzSvgFitTo>(), "AzSvgFitTo"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgFillRule>(), "AzSvgFillRule"), (Layout::new::<AzSvgFillRule>(), "AzSvgFillRule"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgTransform>(), "AzSvgTransform"), (Layout::new::<AzSvgTransform>(), "AzSvgTransform"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgLineJoin>(), "AzSvgLineJoin"), (Layout::new::<AzSvgLineJoin>(), "AzSvgLineJoin"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgLineCap>(), "AzSvgLineCap"), (Layout::new::<AzSvgLineCap>(), "AzSvgLineCap"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgDashPattern>(), "AzSvgDashPattern"), (Layout::new::<AzSvgDashPattern>(), "AzSvgDashPattern"));
        ...
        assert_eq!((Layout::new::<crate::azul_impl::app::Clipboard>(), "AzSystemClipboard"), (Layout::new::<AzSystemClipboard>(), "AzSystemClipboard"));
        ...
        assert_eq!((Layout::new::<azul_core::task::CreateThreadCallback>(), "AzCreateThreadFn"), (Layout::new::<AzCreateThreadFn>(), "AzCreateThreadFn"));
        assert_eq!((Layout::new::<azul_core::task::GetSystemTimeCallback>(), "AzGetSystemTimeFn"), (Layout::new::<AzGetSystemTimeFn>(), "AzGetSystemTimeFn"));
        assert_eq!((Layout::new::<azul_core::task::CheckThreadFinishedCallback>(), "AzCheckThreadFinishedFn"), (Layout::new::<AzCheckThreadFinishedFn>(), "AzCheckThreadFinishedFn"));
        assert_eq!((Layout::new::<azul_core::task::LibrarySendThreadMsgCallback>(), "AzLibrarySendThreadMsgFn"), (Layout::new::<AzLibrarySendThreadMsgFn>(), "AzLibrarySendThreadMsgFn"));
        assert_eq!((Layout::new::<azul_core::task::LibraryReceiveThreadMsgCallback>(), "AzLibraryReceiveThreadMsgFn"), (Layout::new::<AzLibraryReceiveThreadMsgFn>(), "AzLibraryReceiveThreadMsgFn"));
        assert_eq!((Layout::new::<azul_core::task::ThreadRecvCallback>(), "AzThreadRecvFn"), (Layout::new::<AzThreadRecvFn>(), "AzThreadRecvFn"));
        assert_eq!((Layout::new::<azul_core::task::ThreadSendCallback>(), "AzThreadSendFn"), (Layout::new::<AzThreadSendFn>(), "AzThreadSendFn"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgMultiPolygonVecDestructor>(), "AzSvgMultiPolygonVecDestructor"), (Layout::new::<AzSvgMultiPolygonVecDestructor>(), "AzSvgMultiPolygonVecDestructor"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgSimpleNodeVecDestructor>(), "AzSvgSimpleNodeVecDestructor"), (Layout::new::<AzSvgSimpleNodeVecDestructor>(), "AzSvgSimpleNodeVecDestructor"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgPathVecDestructor>(), "AzSvgPathVecDestructor"), (Layout::new::<AzSvgPathVecDestructor>(), "AzSvgPathVecDestructor"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgPathElementVecDestructor>(), "AzSvgPathElementVecDestructor"), (Layout::new::<AzSvgPathElementVecDestructor>(), "AzSvgPathElementVecDestructor"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgVertexVecDestructor>(), "AzSvgVertexVecDestructor"), (Layout::new::<AzSvgVertexVecDestructor>(), "AzSvgVertexVecDestructor"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgColoredVertexVecDestructor>(), "AzSvgColoredVertexVecDestructor"), (Layout::new::<AzSvgColoredVertexVecDestructor>(), "AzSvgColoredVertexVecDestructor"));
        ...
        assert_eq!((Layout::new::<azul_core::callbacks::DomNodeId>(), "AzDomNodeId"), (Layout::new::<AzDomNodeId>(), "AzDomNodeId"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgLine>(), "AzSvgLine"), (Layout::new::<AzSvgLine>(), "AzSvgLine"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgXmlOptions>(), "AzSvgStringFormatOptions"), (Layout::new::<AzSvgStringFormatOptions>(), "AzSvgStringFormatOptions"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgFillStyle>(), "AzSvgFillStyle"), (Layout::new::<AzSvgFillStyle>(), "AzSvgFillStyle"));
        assert_eq!((Layout::new::<azul_core::task::AzInstantPtr>(), "AzInstantPtr"), (Layout::new::<AzInstantPtr>(), "AzInstantPtr"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgVertexVec>(), "AzSvgVertexVec"), (Layout::new::<AzSvgVertexVec>(), "AzSvgVertexVec"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgColoredVertexVec>(), "AzSvgColoredVertexVec"), (Layout::new::<AzSvgColoredVertexVec>(), "AzSvgColoredVertexVec"));
        ...
        assert_eq!((Layout::new::<azul_css::OptionStyleTextAlign>(), "AzOptionStyleTextAlign"), (Layout::new::<AzOptionStyleTextAlign>(), "AzOptionStyleTextAlign"));
        ...
        assert_eq!((Layout::new::<crate::azul_impl::app::OptionClipboard>(), "AzOptionSystemClipboard"), (Layout::new::<AzOptionSystemClipboard>(), "AzOptionSystemClipboard"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgPathElement>(), "AzSvgPathElement"), (Layout::new::<AzSvgPathElement>(), "AzSvgPathElement"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgRenderOptions>(), "AzSvgRenderOptions"), (Layout::new::<AzSvgRenderOptions>(), "AzSvgRenderOptions"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgStrokeStyle>(), "AzSvgStrokeStyle"), (Layout::new::<AzSvgStrokeStyle>(), "AzSvgStrokeStyle"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgPathElementVec>(), "AzSvgPathElementVec"), (Layout::new::<AzSvgPathElementVec>(), "AzSvgPathElementVec"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgPath>(), "AzSvgPath"), (Layout::new::<AzSvgPath>(), "AzSvgPath"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgParseOptions>(), "AzSvgParseOptions"), (Layout::new::<AzSvgParseOptions>(), "AzSvgParseOptions"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgStyle>(), "AzSvgStyle"), (Layout::new::<AzSvgStyle>(), "AzSvgStyle"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgPathVec>(), "AzSvgPathVec"), (Layout::new::<AzSvgPathVec>(), "AzSvgPathVec"));
        ...
        assert_eq!((Layout::new::<crate::azul_impl::file::OptionFile>(), "AzOptionFile"), (Layout::new::<AzOptionFile>(), "AzOptionFile"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgMultiPolygon>(), "AzSvgMultiPolygon"), (Layout::new::<AzSvgMultiPolygon>(), "AzSvgMultiPolygon"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgSimpleNode>(), "AzSvgSimpleNode"), (Layout::new::<AzSvgSimpleNode>(), "AzSvgSimpleNode"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgMultiPolygonVec>(), "AzSvgMultiPolygonVec"), (Layout::new::<AzSvgMultiPolygonVec>(), "AzSvgMultiPolygonVec"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgSimpleNodeVec>(), "AzSvgSimpleNodeVec"), (Layout::new::<AzSvgSimpleNodeVec>(), "AzSvgSimpleNodeVec"));
        ...
        assert_eq!((Layout::new::<azul_core::callbacks::CallbackInfo>(), "AzCallbackInfo"), (Layout::new::<AzCallbackInfo>(), "AzCallbackInfo"));
        ...
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgNode>(), "AzSvgNode"), (Layout::new::<AzSvgNode>(), "AzSvgNode"));
        assert_eq!((Layout::new::<azul_layout::xml::svg::SvgStyledNode>(), "AzSvgStyledNode"), (Layout::new::<AzSvgStyledNode>(), "AzSvgStyledNode"));
