...
pub struct Wayland {
    ...
    /// `wl_display_get_protocol_error(display, &interface, &id) -> code`.
    /// Only meaningful once `wl_display_get_error` reports EPROTO; names the
    /// object that killed the connection.
    pub wl_display_get_protocol_error: unsafe extern "C" fn(
    ...
    pub xdg_toplevel_set_app_id: unsafe extern "C" fn(*mut xdg_toplevel, *const c_char),
...
impl Wayland {
    ...
    pub fn new() -> Result<Rc<Self>, DlError> {
        ...
        let wl = Rc::new(Self {
            ...
            wl_display_get_protocol_error: load_symbol!(
                lib_client,
                _,
            ...
            xdg_toplevel_set_app_id: xdg_toplevel_set_app_id_impl,
...
unsafe extern "C" fn xdg_toplevel_set_app_id_impl(t: *mut xdg_toplevel, app_id: *const c_char) {
    let f: unsafe extern "C" fn(*mut wl_proxy, u32, *const c_char) =
        std::mem::transmute(ctx().marshal);
    f(t as *mut wl_proxy, 3, app_id);
}
