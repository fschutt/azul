...
fn create_color_box(color: &str, label: &str) -> Dom {
    Dom::create_div()
        ...
        .with_children(
            vec![
                Dom::create_div().with_inline_style(&format!(
        ...
        .with_children(
            vec![
                    ...
                    .with_child(Dom::create_text("Checkbox Demo")),
                {
                    ...
                    let mut checkbox = Dom::create_div()
                        .with_inline_style(
                        ...
                        .with_children(
                            vec![
                                {
                                    let mut box_div = Dom::create_div()
                                        .with_inline_style(
                                            format!(
                ...
                Dom::create_div()
                    ...
                    .with_children(
                        vec![
                            // Track
                            {
                                let mut track = Dom::create_div().with_inline_style(
...
extern "C" fn on_code_scroll(data: &mut RefAny, info: &mut CallbackInfo) -> Update {
    ...
    let node_id = match hit_node.node.into_crate_internal() {
        Some(n) => n,
                ...
                Dom::create_div()
                    ...
                    .with_children(
                        vec![
                            // Zoom out button
                            {
                                let mut zoom_out_btn = Dom::create_div()
                                    .with_inline_style(
                            ...
                            // Zoom in button
                            {
                                let mut zoom_in_btn = Dom::create_div()
                                    .with_inline_style(
...
extern "C" fn preview_iframe_callback(
    ...
    let styled_dom = if app_data.code_content.is_empty() {
        let mut preview_dom = Dom::create_body();
