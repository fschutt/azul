        ...
        Dom::create_div()
            ...
            .with_child(
                Dom::create_div()
                    ...
                    .with_child(Dom::create_text(&self.text))
            )
            .with_child(
                Dom::create_div()
                    ...
                    .with_child(Dom::create_text("Instructions:"))
                    .with_child(Dom::create_text("• Click to place cursor"))
                    .with_child(Dom::create_text("• Type to insert text"))
                    .with_child(Dom::create_text("• Arrow keys to move cursor"))
                    .with_child(Dom::create_text("• Cursor auto-scrolls into view"))
                    .with_child(Dom::create_text("• Try Japanese/Chinese IME"))
            )
    }
}
