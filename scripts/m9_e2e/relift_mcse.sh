...
mv /c/Users/felix/AppData/Local/Temp/az-lift-cache "/c/Users/felix/AppData/Local/Temp/az-lift-cache.bak2_$(date +%s)" 2>/dev/null && echo "cache cleared"
bash scripts/m9_e2e/baseline_build.sh
RES=/c/rb/relift_mcse.log
echo "=== probing solveLayoutReal (mcse/sink/storemerge OFF) $(date +%H:%M:%S) ===" >> "$RES"
sleep 3
