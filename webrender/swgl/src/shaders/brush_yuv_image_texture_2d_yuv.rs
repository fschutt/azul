...
struct BrushYuvImageTexture2DYuvCommon {
...
#[derive(Clone, Debug, Default)]
struct BrushYuvImageTexture2DYuvVert {
    common: BrushYuvImageTexture2DYuvCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushYuvImageTexture2DYuvVert {
...
impl VertexShader for BrushYuvImageTexture2DYuvVert {
...
#[derive(Clone, Debug, Default)]
struct BrushYuvImageTexture2DYuvFrag {
    vert: BrushYuvImageTexture2DYuvVert,
...
impl BrushYuvImageTexture2DYuvFrag {
...
impl FragmentShader for BrushYuvImageTexture2DYuvFrag {
...
#[derive(Clone, Debug, Default)]
pub struct BrushYuvImageTexture2DYuvProgram {
    frag: BrushYuvImageTexture2DYuvFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushYuvImageTexture2DYuvProgram::default())
}

impl Program for BrushYuvImageTexture2DYuvProgram {
