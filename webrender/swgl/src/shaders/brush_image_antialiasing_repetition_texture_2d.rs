...
// Corresponds to brush_image_ANTIALIASING_REPETITION_TEXTURE_2D_common
#[derive(Clone, Debug, Default)]
struct BrushImageAntialiasingRepetitionTexture2DCommon {
...
// Corresponds to brush_image_ANTIALIASING_REPETITION_TEXTURE_2D_vert
#[derive(Clone, Debug, Default)]
struct BrushImageAntialiasingRepetitionTexture2DVert {
    common: BrushImageAntialiasingRepetitionTexture2DCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushImageAntialiasingRepetitionTexture2DVert {
    #[inline(always)]
...
impl VertexShader for BrushImageAntialiasingRepetitionTexture2DVert {
    ...
    fn set_uniform_1i(&mut self, _index: i32, _value: i32) {
        // Sampler slots handled by the context
    }
...
// Corresponds to brush_image_ANTIALIASING_REPETITION_TEXTURE_2D_frag
#[derive(Clone, Debug, Default)]
struct BrushImageAntialiasingRepetitionTexture2DFrag {
    vert: BrushImageAntialiasingRepetitionTexture2DVert,
...
impl BrushImageAntialiasingRepetitionTexture2DFrag {
...
impl FragmentShader for BrushImageAntialiasingRepetitionTexture2DFrag {
    ...
    fn draw_span_rgba8(&mut self, context: &mut ShaderContext) -> i32 {
        ...
        //     SamplerId::SColor0,
        //     uv,
        //     vec2::ZERO, // This is not present in the C++ code for this shader variant
...
// Corresponds to brush_image_ANTIALIASING_REPETITION_TEXTURE_2D_program
#[derive(Clone, Debug, Default)]
pub struct BrushImageAntialiasingRepetitionTexture2DProgram {
    frag: BrushImageAntialiasingRepetitionTexture2DFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushImageAntialiasingRepetitionTexture2DProgram::default())
}

impl Program for BrushImageAntialiasingRepetitionTexture2DProgram {
