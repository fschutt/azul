...
struct BrushYuvImageAlphaPassTextureRectYuvCommon {
...
#[derive(Clone, Debug, Default)]
struct BrushYuvImageAlphaPassTextureRectYuvVert {
    common: BrushYuvImageAlphaPassTextureRectYuvCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushYuvImageAlphaPassTextureRectYuvVert {
    ...
    fn brush_shader_main_vs(
        ...
        self.brush_vs(context, vi, ph.specific_prim_address, ph.local_rect, ph.user_data);
    }
    ...
    fn brush_vs(
        ...
        if prim.yuv_format == 3 || prim.yuv_format == 99 {
            ...
            self.write_uv_rect(res_y_uv.p0, res_y_uv.p1, f, &mut self.v_uv_y, &mut self.common.v_uv_bounds_y);
            self.write_uv_rect(res_u_uv.p0, res_u_uv.p1, f, &mut self.v_uv_u, &mut self.common.v_uv_bounds_u);
            self.write_uv_rect(res_v_uv.p0, res_v_uv.p1, f, &mut self.v_uv_v, &mut self.common.v_uv_bounds_v);
...
impl VertexShader for BrushYuvImageAlphaPassTextureRectYuvVert {
...
#[derive(Clone, Debug, Default)]
struct BrushYuvImageAlphaPassTextureRectYuvFrag {
    vert: BrushYuvImageAlphaPassTextureRectYuvVert,
...
impl BrushYuvImageAlphaPassTextureRectYuvFrag {
...
impl FragmentShader for BrushYuvImageAlphaPassTextureRectYuvFrag {
    ...
    fn draw_span_rgba8(&mut self, context: &mut ShaderContext) -> i32 {
        if self.vert.common.v_format.x == 3 {
            // swgl_commitTextureLinearYUV_rect(3 plane)
        } else if self.vert.common.v_format.x == 0 || self.vert.common.v_format.x == 1 {
            // swgl_commitTextureLinearYUV_rect(2 plane)
        } else if self.vert.common.v_format.x == 4 {
            // swgl_commitTextureLinearYUV_rect(1 plane)
        }
        1
    }
}
...
#[derive(Clone, Debug, Default)]
pub struct BrushYuvImageAlphaPassTextureRectYuvProgram {
    frag: BrushYuvImageAlphaPassTextureRectYuvFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushYuvImageAlphaPassTextureRectYuvProgram::default())
}

impl Program for BrushYuvImageAlphaPassTextureRectYuvProgram {
