...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_ANTIALIASING_REPETITION_TEXTURE_RECT_common
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectCommon {
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_ANTIALIASING_REPETITION_TEXTURE_RECT_vert
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectVert {
    common: BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectVert {
    #[inline(always)]
    ...
    fn brush_vs(
        ...
        self.v_uv /= texture_size; // A no-op
        ...
        match color_mode {
            0 | 2 => {
                // swgl_blendDropShadow(image_data.color); // This is a rasterizer state change
...
impl VertexShader for BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectVert {
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_ANTIALIASING_REPETITION_TEXTURE_RECT_frag
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectFrag {
    vert: BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectVert,
    v_uv: vec2,
    interp_step: InterpOutputs,
    interp_perspective: InterpOutputs,
}

impl BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectFrag {
    ...
    fn do_clip(&self, _context: &ShaderContext) -> f32 {
        1.0 // Placeholder for clip mask sampling
    }
    ...
    fn main(&self, context: &ShaderContext) -> vec4 {
        ...
        texel.truncate() = (texel.rgb() * self.vert.common.v_mask_swizzle.x)
            + (vec3::splat(texel.a) * self.vert.common.v_mask_swizzle.y);
...
impl FragmentShader for BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectFrag {
    ...
    fn draw_span_rgba8(&mut self, context: &mut ShaderContext) -> i32 {
        ...
        if self.vert.common.v_color != vec4::ONE {
            context.commit_texture_repeat_color_rgba8_rect(
                SamplerId::SColor0,
                uv,
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_ANTIALIASING_REPETITION_TEXTURE_RECT_program
#[derive(Clone, Debug, Default)]
pub struct BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectProgram {
    frag: BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectProgram::default())
}

impl Program for BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTextureRectProgram {
