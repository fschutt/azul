...
use glam::{bvec2, ivec4, mat4, vec2, vec3, vec4, BVec2, Mat4, Vec2, Vec3, Vec4};
use std::ffi::CStr;
use std::mem;
use super::strcmp;

// Corresponds to brush_image_ALPHA_PASS_TEXTURE_2D_common
#[derive(Clone, Debug, Default)]
struct BrushImageAlphaPassTexture2DCommon {
...
// Corresponds to brush_image_ALPHA_PASS_TEXTURE_2D_vert
#[derive(Clone, Debug, Default)]
struct BrushImageAlphaPassTexture2DVert {
    common: BrushImageAlphaPassTexture2DCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushImageAlphaPassTexture2DVert {
    ...
    fn brush_vs(
        ...
        let normalized_offset = vec2::ZERO; // Simplified from original, no centering flags checked here
...
impl VertexShader for BrushImageAlphaPassTexture2DVert {
...
// Corresponds to brush_image_ALPHA_PASS_TEXTURE_2D_frag
#[derive(Clone, Debug, Default)]
struct BrushImageAlphaPassTexture2DFrag {
    vert: BrushImageAlphaPassTexture2DVert,
...
impl BrushImageAlphaPassTexture2DFrag {
...
impl FragmentShader for BrushImageAlphaPassTexture2DFrag {
    ...
    fn draw_span_rgba8(&mut self, context: &mut ShaderContext) -> i32 {
        ...
        if self.vert.common.v_color != vec4::ONE {
            context.commit_texture_color_rgba8(SamplerId::SColor0, uv, self.vert.common.v_uv_sample_bounds, self.vert.common.v_color);
        } else {
...
// Corresponds to brush_image_ALPHA_PASS_TEXTURE_2D_program
#[derive(Clone, Debug, Default)]
pub struct BrushImageAlphaPassTexture2DProgram {
    frag: BrushImageAlphaPassTexture2DFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushImageAlphaPassTexture2DProgram::default())
}

impl Program for BrushImageAlphaPassTexture2DProgram {
