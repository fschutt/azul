...
struct BrushYuvImageTextureRectYuvCommon {
...
#[derive(Clone, Debug, Default)]
struct BrushYuvImageTextureRectYuvVert {
    common: BrushYuvImageTextureRectYuvCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushYuvImageTextureRectYuvVert {
...
impl VertexShader for BrushYuvImageTextureRectYuvVert {
...
#[derive(Clone, Debug, Default)]
struct BrushYuvImageTextureRectYuvFrag {
    vert: BrushYuvImageTextureRectYuvVert,
...
impl BrushYuvImageTextureRectYuvFrag {
...
impl FragmentShader for BrushYuvImageTextureRectYuvFrag {
    ...
    fn draw_span_rgba8(&mut self, context: &mut ShaderContext) -> i32 {
        if self.vert.common.v_format.x == 3 {
            // swgl_commitTextureLinearYUV_rect(3 plane) - backend needs this
...
#[derive(Clone, Debug, Default)]
pub struct BrushYuvImageTextureRectYuvProgram {
    frag: BrushYuvImageTextureRectYuvFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushYuvImageTextureRectYuvProgram::default())
}

impl Program for BrushYuvImageTextureRectYuvProgram {
