...
// Corresponds to brush_opacity_ALPHA_PASS_ANTIALIASING_common
#[derive(Clone, Debug, Default)]
struct BrushOpacityAlphaPassAntialiasingCommon {
...
// Corresponds to brush_opacity_ALPHA_PASS_ANTIALIASING_vert
#[derive(Clone, Debug, Default)]
struct BrushOpacityAlphaPassAntialiasingVert {
    common: BrushOpacityAlphaPassAntialiasingCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushOpacityAlphaPassAntialiasingVert {
...
impl VertexShader for BrushOpacityAlphaPassAntialiasingVert {
...
// Corresponds to brush_opacity_ALPHA_PASS_ANTIALIASING_frag
#[derive(Clone, Debug, Default)]
struct BrushOpacityAlphaPassAntialiasingFrag {
    vert: BrushOpacityAlphaPassAntialiasingVert,
    v_uv: vec2,
    interp_step: InterpOutputs,
    interp_perspective: InterpOutputs,
}

impl BrushOpacityAlphaPassAntialiasingFrag {
    fn main(&self, context: &ShaderContext) -> vec4 {
        ...
        let mut final_color = color * alpha;

        let clip_alpha = self.do_clip(context);
        final_color *= clip_alpha;

        final_color
    }
    
    fn antialias_brush(&self) -> f32 {
        // In a real implementation this would get coverage from the rasterizer state
        1.0
    }

    fn do_clip(&self, context: &ShaderContext) -> f32 {
        // In a real implementation this would sample the clip mask
        // return context.texture(SamplerId::SClipMask, ...).a;
        1.0
    }
}

impl FragmentShader for BrushOpacityAlphaPassAntialiasingFrag {
...
// Corresponds to brush_opacity_ALPHA_PASS_ANTIALIASING_program
#[derive(Clone, Debug, Default)]
pub struct BrushOpacityAlphaPassAntialiasingProgram {
    frag: BrushOpacityAlphaPassAntialiasingFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushOpacityAlphaPassAntialiasingProgram::default())
}

impl Program for BrushOpacityAlphaPassAntialiasingProgram {
