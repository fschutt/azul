...
use glam::{bvec2, ivec2, ivec4, mat4, vec2, vec4, BVec2, Mat4, Vec2, Vec4};
use std::ffi::CStr;
use std::mem;
use super::strcmp;

// Corresponds to brush_image_ANTIALIASING_REPETITION_TEXTURE_RECT_common
#[derive(Clone, Debug, Default)]
struct BrushImageAntialiasingRepetitionTextureRectCommon {
...
// Corresponds to brush_image_ANTIALIASING_REPETITION_TEXTURE_RECT_vert
#[derive(Clone, Debug, Default)]
struct BrushImageAntialiasingRepetitionTextureRectVert {
    common: BrushImageAntialiasingRepetitionTextureRectCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushImageAntialiasingRepetitionTextureRectVert {
    #[inline(always)]
    ...
    fn brush_vs(
        ...
        let image_data = context.fetch_image_data(prim_address);
        ...
        self.common.v_uv_sample_bounds =
            vec4(min_uv.x + 0.5, min_uv.y + 0.5, max_uv.x - 0.5, max_uv.y - 0.5);
...
impl VertexShader for BrushImageAntialiasingRepetitionTextureRectVert {
    ...
    fn set_uniform_1i(&mut self, _index: i32, _value: i32) {
        // Sampler slots are handled by the context/backend
    }
...
// Corresponds to brush_image_ANTIALIASING_REPETITION_TEXTURE_RECT_frag
#[derive(Clone, Debug, Default)]
struct BrushImageAntialiasingRepetitionTextureRectFrag {
    vert: BrushImageAntialiasingRepetitionTextureRectVert,
...
impl BrushImageAntialiasingRepetitionTextureRectFrag {
    fn compute_repeated_uvs(&self, perspective_divisor: f32) -> vec2 {
        ...
        let repeated_uv = (self.v_uv * perspective_divisor).fract() * uv_size
            + self.vert.common.v_uv_bounds.xy();
        repeated_uv
    }
    ...
    fn main(&self, context: &ShaderContext) -> vec4 {
        ...
        let perspective_divisor = (1.0 - self.vert.common.v_perspective.x) * gl_frag_coord_w
            + self.vert.common.v_perspective.x;
        ...
        context.texture_rect(SamplerId::SColor0, uv)
    }
}

impl FragmentShader for BrushImageAntialiasingRepetitionTextureRectFrag {
    ...
    fn draw_span_rgba8(&mut self, context: &mut ShaderContext) -> i32 {
        ...
        // context.commit_texture_repeat_rgba8_rect(
        //     SamplerId::SColor0,
        //     uv,
        //     vec2::ZERO,
...
// Corresponds to brush_image_ANTIALIASING_REPETITION_TEXTURE_RECT_program
#[derive(Clone, Debug, Default)]
pub struct BrushImageAntialiasingRepetitionTextureRectProgram {
    frag: BrushImageAntialiasingRepetitionTextureRectFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushImageAntialiasingRepetitionTextureRectProgram::default())
}

impl Program for BrushImageAntialiasingRepetitionTextureRectProgram {
