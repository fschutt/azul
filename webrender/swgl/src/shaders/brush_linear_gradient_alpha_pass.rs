...
struct BrushLinearGradientAlphaPassCommon {
...
#[derive(Clone, Debug, Default)]
struct BrushLinearGradientAlphaPassVert {
    common: BrushLinearGradientAlphaPassCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushLinearGradientAlphaPassVert {
...
impl VertexShader for BrushLinearGradientAlphaPassVert {
...
// Corresponds to brush_linear_gradient_ALPHA_PASS_frag
#[derive(Clone, Debug, Default)]
struct BrushLinearGradientAlphaPassFrag {
    vert: BrushLinearGradientAlphaPassVert,
    // Varying inputs
    v_pos: vec2,
...
impl BrushLinearGradientAlphaPassFrag {
    ...
    fn brush_fs(&self, context: &ShaderContext) -> vec4 {
        let mut color = self.sample_gradient(self.get_gradient_offset(self.compute_repeated_pos()), context);
...
impl FragmentShader for BrushLinearGradientAlphaPassFrag {
...
// Corresponds to brush_linear_gradient_ALPHA_PASS_program
#[derive(Clone, Debug, Default)]
pub struct BrushLinearGradientAlphaPassProgram {
    frag: BrushLinearGradientAlphaPassFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushLinearGradientAlphaPassProgram::default())
}

impl Program for BrushLinearGradientAlphaPassProgram {
