...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_TEXTURE_RECT_common
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassTextureRectCommon {
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_TEXTURE_RECT_vert
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassTextureRectVert {
    common: BrushImageAdvancedBlendAlphaPassTextureRectCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushImageAdvancedBlendAlphaPassTextureRectVert {
    #[inline(always)]
    ...
    fn brush_vs(
        ...
        let texture_size = vec2::ONE; // Not used for TEXTURE_RECT in the same way
        ...
        self.common.v_tile_repeat_bounds = repeat; // No normalized offset logic in this shader variant
...
impl VertexShader for BrushImageAdvancedBlendAlphaPassTextureRectVert {
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_TEXTURE_RECT_frag
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassTextureRectFrag {
    vert: BrushImageAdvancedBlendAlphaPassTextureRectVert,
    // Varying inputs
    v_uv: vec2,
...
impl BrushImageAdvancedBlendAlphaPassTextureRectFrag {
...
impl FragmentShader for BrushImageAdvancedBlendAlphaPassTextureRectFrag {
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_TEXTURE_RECT_program
#[derive(Clone, Debug, Default)]
pub struct BrushImageAdvancedBlendAlphaPassTextureRectProgram {
    frag: BrushImageAdvancedBlendAlphaPassTextureRectFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushImageAdvancedBlendAlphaPassTextureRectProgram::default())
}

impl Program for BrushImageAdvancedBlendAlphaPassTextureRectProgram {
