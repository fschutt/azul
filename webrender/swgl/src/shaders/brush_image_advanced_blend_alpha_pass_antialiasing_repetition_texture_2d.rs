...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_ANTIALIASING_REPETITION_TEXTURE_2D_common
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DCommon {
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_ANTIALIASING_REPETITION_TEXTURE_2D_vert
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DVert {
    common: BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DCommon,
    // Inputs
    a_position: vec2,
    a_data: ivec4,
    // Outputs
...
impl BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DVert {
...
impl VertexShader for BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DVert {
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_ANTIALIASING_REPETITION_TEXTURE_2D_frag
#[derive(Clone, Debug, Default)]
struct BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DFrag {
    vert: BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DVert,
...
impl BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DFrag {
...
impl FragmentShader for BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DFrag {
...
// Corresponds to brush_image_ADVANCED_BLEND_ALPHA_PASS_ANTIALIASING_REPETITION_TEXTURE_2D_program
#[derive(Clone, Debug, Default)]
pub struct BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DProgram {
    frag: BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DFrag,
}

pub fn loader() -> Box<dyn Program> {
    Box::new(BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DProgram::default())
}

impl Program for BrushImageAdvancedBlendAlphaPassAntialiasingRepetitionTexture2DProgram {
