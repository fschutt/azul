...
mod tests {
    ...
    use azul_core::{dom::NodeType, styled_dom::StyledDom};
    use azul_css::Css;
    use azul_layout::{
        font::FontCache,
        solver3::{
            layout_tree::{generate_layout_tree, PseudoElement},
            LayoutContext,
        },
        text3::cache::InMemoryFontDb,
    };
    ...
    fn create_test_tree(
        ...
        azul_layout::solver3::LayoutTree<azul_layout::font::parsed::ParsedFont>,
        azul_layout::solver3::LayoutError,
    > {
        // Parse HTML
    ...
    fn test_nested_lists_have_separate_markers() {
        ...
        assert_eq!(
            marker_count, 4,
            "Should have 4 ::marker pseudo-elements total"
        );
    }
    ...
    fn test_layout_tree_structure_matches_spec() {
        ...
        assert_eq!(
            first_child.dom_node_id, li_node.dom_node_id,
