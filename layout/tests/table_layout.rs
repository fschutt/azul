...
use azul_layout::solver3::fc::{
    BorderSource, BorderInfo, TableColumnInfo, TableCellInfo,
};
use azul_css::props::{
    basic::ColorU,
    style::BorderStyle,
...
fn test_border_conflict_source_priority_full_hierarchy() {
    ...
    let borders = vec![
        (BorderSource::Table, ColorU { r: 10, g: 0, b: 0, a: 255 }),
        (BorderSource::ColumnGroup, ColorU { r: 20, g: 0, b: 0, a: 255 }),
        (BorderSource::Column, ColorU { r: 30, g: 0, b: 0, a: 255 }),
        (BorderSource::RowGroup, ColorU { r: 40, g: 0, b: 0, a: 255 }),
        (BorderSource::Row, ColorU { r: 50, g: 0, b: 0, a: 255 }),
        (BorderSource::Cell, ColorU { r: 60, g: 0, b: 0, a: 255 }),
    ];
    ...
    let cell = BorderInfo {
        width: 2.0,
        style: BorderStyle::Solid,
        color: ColorU { r: 60, g: 0, b: 0, a: 255 },
        source: BorderSource::Cell,
    };
    ...
    let row = BorderInfo {
        width: 2.0,
        style: BorderStyle::Solid,
        color: ColorU { r: 50, g: 0, b: 0, a: 255 },
        source: BorderSource::Row,
    };
    ...
    let table = BorderInfo {
        width: 2.0,
        style: BorderStyle::Solid,
        color: ColorU { r: 10, g: 0, b: 0, a: 255 },
...
fn test_border_style_priority_full_hierarchy() {
    ...
    let styles = vec![
        (BorderStyle::Double, ColorU { r: 1, g: 0, b: 0, a: 255 }),
        (BorderStyle::Solid, ColorU { r: 2, g: 0, b: 0, a: 255 }),
        (BorderStyle::Dashed, ColorU { r: 3, g: 0, b: 0, a: 255 }),
        (BorderStyle::Dotted, ColorU { r: 4, g: 0, b: 0, a: 255 }),
        (BorderStyle::Ridge, ColorU { r: 5, g: 0, b: 0, a: 255 }),
        (BorderStyle::Outset, ColorU { r: 6, g: 0, b: 0, a: 255 }),
        (BorderStyle::Groove, ColorU { r: 7, g: 0, b: 0, a: 255 }),
        (BorderStyle::Inset, ColorU { r: 8, g: 0, b: 0, a: 255 }),
    ];
    ...
    let double = BorderInfo {
        width: 2.0,
        style: BorderStyle::Double,
        color: ColorU { r: 1, g: 0, b: 0, a: 255 },
        source: BorderSource::Cell,
    };
...
fn test_realistic_table_scenario_1() {
    ...
    let table_border = BorderInfo {
        width: 1.0,
        style: BorderStyle::Solid,
        color: ColorU { r: 128, g: 128, b: 128, a: 255 }, // Gray
        source: BorderSource::Table,
    };
    ...
    let cell_border = BorderInfo {
        width: 3.0,
        style: BorderStyle::Solid,
        color: ColorU { r: 255, g: 0, b: 0, a: 255 }, // Red
        source: BorderSource::Cell,
    };
...
fn test_realistic_table_scenario_2() {
    ...
    let row_border = BorderInfo {
        width: 2.0,
        style: BorderStyle::Solid,
        color: ColorU { r: 0, g: 0, b: 255, a: 255 }, // Blue
        source: BorderSource::Row,
    };
...
fn test_table_cell_grid_layout() {
    ...
    let cells = vec![
        // Row 0
        TableCellInfo { node_index: 0, column: 0, colspan: 1, row: 0, rowspan: 1 },
        TableCellInfo { node_index: 1, column: 1, colspan: 1, row: 0, rowspan: 1 },
        TableCellInfo { node_index: 2, column: 2, colspan: 1, row: 0, rowspan: 1 },
        // Row 1
        TableCellInfo { node_index: 3, column: 0, colspan: 1, row: 1, rowspan: 1 },
        TableCellInfo { node_index: 4, column: 1, colspan: 1, row: 1, rowspan: 1 },
        TableCellInfo { node_index: 5, column: 2, colspan: 1, row: 1, rowspan: 1 },
        // Row 2
        TableCellInfo { node_index: 6, column: 0, colspan: 1, row: 2, rowspan: 1 },
        TableCellInfo { node_index: 7, column: 1, colspan: 1, row: 2, rowspan: 1 },
        TableCellInfo { node_index: 8, column: 2, colspan: 1, row: 2, rowspan: 1 },
    ];
...
fn test_table_cell_grid_with_colspan() {
    ...
    let cells = vec![
        ...
        TableCellInfo { node_index: 0, column: 0, colspan: 2, row: 0, rowspan: 1 },
        // Row 1: Two normal cells
        TableCellInfo { node_index: 1, column: 0, colspan: 1, row: 1, rowspan: 1 },
        TableCellInfo { node_index: 2, column: 1, colspan: 1, row: 1, rowspan: 1 },
    ];
...
fn test_table_cell_grid_with_rowspan() {
    ...
    let cells = vec![
        ...
        TableCellInfo { node_index: 0, column: 0, colspan: 1, row: 0, rowspan: 2 },
