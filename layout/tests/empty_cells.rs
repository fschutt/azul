...
fn test_empty_cell_detection_logic() {
    ...
    let cells = vec![
        CellInfo { has_children: false, has_inline_content: false },  // Empty
        CellInfo { has_children: true, has_inline_content: false },   // Has block content
        CellInfo { has_children: true, has_inline_content: true },    // Has inline content
        CellInfo { has_children: false, has_inline_content: true },   // Empty with inline result
    ];
