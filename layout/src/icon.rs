...
pub fn register_embedded_material_icons(provider: &mut IconProviderHandle) -> bool {
    ...
    // Get the embedded Material Icons font bytes (brotli-decompressed on first use)
    let font_bytes: &'static [u8] = get_material_icons_font_bytes().expect("icons feature enabled");
...
/// Brotli-compressed Material Icons font (generated by `azul-doc codegen all`).
/// 348KB raw → ~130KB compressed. Decompressed lazily on first use.
#[cfg(feature = "icons")]
...
/// Lazily-decompressed Material Icons font bytes.
#[cfg(feature = "icons")]
...
///
/// The font is stored brotli-compressed and decompressed on first access.
#[cfg(feature = "icons")]
