...
pub fn get_item_vertical_metrics_approx(item: &ShapedItem) -> (f32, f32) {
    ...
    match item {
        ...
        ShapedItem::CombinedBlock { bounds, .. } => (bounds.height * FALLBACK_ASCENT_RATIO, bounds.height * FALLBACK_DESCENT_RATIO),
        ShapedItem::Object { bounds, .. } => (bounds.height, 0.0),
        ShapedItem::Tab { bounds, .. } => (bounds.height * FALLBACK_ASCENT_RATIO, bounds.height * FALLBACK_DESCENT_RATIO),
