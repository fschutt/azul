...
mod cursor_scroll_tests {
    ...
    fn test_no_scroll_when_cursor_visible() {
        ...
        assert!(cursor_rect.origin.x >= visible_area.origin.x + SCROLL_PADDING);
        assert!(cursor_rect.origin.x + cursor_rect.size.width <= visible_area.origin.x + visible_area.size.width - SCROLL_PADDING);
        assert!(cursor_rect.origin.y >= visible_area.origin.y + SCROLL_PADDING);
        assert!(cursor_rect.origin.y + cursor_rect.size.height <= visible_area.origin.y + visible_area.size.height - SCROLL_PADDING);
    }
