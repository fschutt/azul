...
// Light mode colors
pub const LIGHT_PG: ColorU = ColorU { r: 230, g: 228, b: 223, a: 255 };
pub const LIGHT_SUR: ColorU = ColorU { r: 242, g: 241, b: 237, a: 255 };
pub const LIGHT_DESK: ColorU = ColorU { r: 221, g: 219, b: 213, a: 255 };
pub const LIGHT_STRIP: ColorU = ColorU { r: 233, g: 231, b: 226, a: 255 };
pub const LIGHT_TRACK: ColorU = ColorU { r: 231, g: 229, b: 224, a: 255 };
pub const LIGHT_BD: ColorU = ColorU { r: 198, g: 195, b: 187, a: 255 };
pub const LIGHT_BD2: ColorU = ColorU { r: 180, g: 177, b: 169, a: 255 };
pub const LIGHT_BD3: ColorU = ColorU { r: 156, g: 152, b: 144, a: 255 };
pub const LIGHT_BD4: ColorU = ColorU { r: 210, g: 207, b: 200, a: 255 };
pub const LIGHT_BD5: ColorU = ColorU { r: 165, g: 161, b: 153, a: 255 };
pub const LIGHT_SEP: ColorU = ColorU { r: 216, g: 213, b: 206, a: 255 };
pub const LIGHT_SEP2: ColorU = ColorU { r: 224, g: 221, b: 215, a: 255 };
pub const LIGHT_INK: ColorU = ColorU { r: 38, g: 37, b: 33, a: 255 };
pub const LIGHT_INK2: ColorU = ColorU { r: 46, g: 44, b: 38, a: 255 };
pub const LIGHT_INTRO: ColorU = ColorU { r: 78, g: 76, b: 69, a: 255 };
pub const LIGHT_SOFT1: ColorU = ColorU { r: 102, g: 100, b: 92, a: 255 };
pub const LIGHT_SOFT2: ColorU = ColorU { r: 130, g: 127, b: 118, a: 255 };
pub const LIGHT_SOFT3: ColorU = ColorU { r: 116, g: 113, b: 106, a: 255 };
pub const LIGHT_ICON: ColorU = ColorU { r: 86, g: 84, b: 76, a: 255 };
pub const LIGHT_RT: ColorU = ColorU { r: 250, g: 249, b: 245, a: 255 };
pub const LIGHT_RB: ColorU = ColorU { r: 236, g: 234, b: 228, a: 255 };
pub const LIGHT_HT: ColorU = ColorU { r: 254, g: 253, b: 250, a: 255 };
pub const LIGHT_HB: ColorU = ColorU { r: 241, g: 239, b: 233, a: 255 };
pub const LIGHT_PT: ColorU = ColorU { r: 228, g: 225, b: 218, a: 255 };
pub const LIGHT_PB: ColorU = ColorU { r: 238, g: 236, b: 230, a: 255 };
pub const LIGHT_FLD: ColorU = ColorU { r: 251, g: 250, b: 246, a: 255 };
pub const LIGHT_FLD2: ColorU = ColorU { r: 239, g: 237, b: 231, a: 255 };
pub const LIGHT_DISBG: ColorU = ColorU { r: 235, g: 233, b: 227, a: 255 };
pub const LIGHT_DISTX: ColorU = ColorU { r: 163, g: 160, b: 153, a: 255 };
pub const LIGHT_QT: ColorU = ColorU { r: 110, g: 99, b: 73, a: 255 };
pub const LIGHT_QT2: ColorU = ColorU { r: 79, g: 70, b: 51, a: 255 };
pub const LIGHT_ACC: ColorU = ColorU { r: 47, g: 74, b: 133, a: 255 };
pub const LIGHT_DEEP: ColorU = ColorU { r: 30, g: 50, b: 96, a: 255 };
pub const LIGHT_SOFT: ColorU = ColorU { r: 224, g: 228, b: 238, a: 255 };
pub const LIGHT_GLOW: ColorU = ColorU { r: 122, g: 147, b: 198, a: 255 };
pub const LIGHT_ON_ACC: ColorU = ColorU { r: 244, g: 242, b: 234, a: 255 };

// Dark mode colors
pub const DARK_PG: ColorU = ColorU { r: 26, g: 26, b: 26, a: 255 };
pub const DARK_SUR: ColorU = ColorU { r: 35, g: 35, b: 35, a: 255 };
pub const DARK_DESK: ColorU = ColorU { r: 18, g: 18, b: 18, a: 255 };
pub const DARK_STRIP: ColorU = ColorU { r: 31, g: 31, b: 31, a: 255 };
pub const DARK_TRACK: ColorU = ColorU { r: 21, g: 21, b: 21, a: 255 };
pub const DARK_BD: ColorU = ColorU { r: 63, g: 63, b: 63, a: 255 };
pub const DARK_BD2: ColorU = ColorU { r: 74, g: 74, b: 74, a: 255 };
pub const DARK_BD3: ColorU = ColorU { r: 97, g: 97, b: 97, a: 255 };
pub const DARK_BD4: ColorU = ColorU { r: 52, g: 52, b: 52, a: 255 };
pub const DARK_BD5: ColorU = ColorU { r: 16, g: 16, b: 16, a: 255 };
pub const DARK_SEP: ColorU = ColorU { r: 56, g: 56, b: 56, a: 255 };
pub const DARK_SEP2: ColorU = ColorU { r: 46, g: 46, b: 46, a: 255 };
pub const DARK_INK: ColorU = ColorU { r: 231, g: 231, b: 231, a: 255 };
pub const DARK_INK2: ColorU = ColorU { r: 220, g: 220, b: 220, a: 255 };
pub const DARK_INTRO: ColorU = ColorU { r: 188, g: 188, b: 188, a: 255 };
pub const DARK_SOFT1: ColorU = ColorU { r: 168, g: 168, b: 168, a: 255 };
pub const DARK_SOFT2: ColorU = ColorU { r: 140, g: 140, b: 140, a: 255 };
pub const DARK_SOFT3: ColorU = ColorU { r: 154, g: 154, b: 154, a: 255 };
pub const DARK_ICON: ColorU = ColorU { r: 190, g: 190, b: 190, a: 255 };
pub const DARK_RT: ColorU = ColorU { r: 51, g: 51, b: 51, a: 255 };
pub const DARK_RB: ColorU = ColorU { r: 41, g: 41, b: 41, a: 255 };
pub const DARK_HT: ColorU = ColorU { r: 63, g: 63, b: 63, a: 255 };
pub const DARK_HB: ColorU = ColorU { r: 51, g: 51, b: 51, a: 255 };
pub const DARK_PT: ColorU = ColorU { r: 31, g: 31, b: 31, a: 255 };
pub const DARK_PB: ColorU = ColorU { r: 38, g: 38, b: 38, a: 255 };
pub const DARK_FLD: ColorU = ColorU { r: 29, g: 29, b: 29, a: 255 };
pub const DARK_FLD2: ColorU = ColorU { r: 36, g: 36, b: 36, a: 255 };
pub const DARK_DISBG: ColorU = ColorU { r: 36, g: 36, b: 36, a: 255 };
pub const DARK_DISTX: ColorU = ColorU { r: 102, g: 102, b: 102, a: 255 };
pub const DARK_QT: ColorU = ColorU { r: 196, g: 181, b: 142, a: 255 };
pub const DARK_QT2: ColorU = ColorU { r: 222, g: 211, b: 180, a: 255 };
pub const DARK_ACC: ColorU = ColorU { r: 47, g: 74, b: 133, a: 255 };
pub const DARK_DEEP: ColorU = ColorU { r: 30, g: 50, b: 96, a: 255 };
pub const DARK_SOFT: ColorU = ColorU { r: 224, g: 228, b: 238, a: 255 };
pub const DARK_GLOW: ColorU = ColorU { r: 122, g: 147, b: 198, a: 255 };
pub const DARK_ON_ACC: ColorU = ColorU { r: 244, g: 242, b: 234, a: 255 };
...
pub fn button(btn: Button) -> Dom {
    ...
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BackgroundContent(
        StyleBackgroundContentVec::from_vec(vec![StyleBackgroundContent::Color(DARK_SUR)]).into()
    )));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::TextColor(
        StyleTextColor { inner: DARK_INK }.into()
    )));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BorderTopColor(
        StyleBorderTopColor { inner: DARK_BD }.into()
    )));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BorderBottomColor(
        StyleBorderBottomColor { inner: DARK_BD }.into()
    )));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BorderLeftColor(
        StyleBorderLeftColor { inner: DARK_BD }.into()
    )));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BorderRightColor(
        StyleBorderRightColor { inner: DARK_BD }.into()
    )));
...
pub fn check_box(cb: CheckBox) -> Dom {
    ...
    if checked_now {
        content_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BackgroundContent(
            StyleBackgroundContentVec::from_vec(vec![StyleBackgroundContent::Color(DARK_INK)]).into()
        )));
    }
...
pub fn slider(slider: crate::widgets::slider::Slider) -> Dom {
    ...
    track_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BackgroundContent(
        StyleBackgroundContentVec::from_vec(vec![StyleBackgroundContent::Color(DARK_TRACK)]).into()
    )));
    thumb_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BackgroundContent(
        StyleBackgroundContentVec::from_vec(vec![StyleBackgroundContent::Color(DARK_ACC)]).into()
    )));
...
pub fn text_area(mut ta: crate::widgets::text_area::TextArea) -> Dom {
    ...
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BackgroundContent(StyleBackgroundContentVec::from_vec(vec![StyleBackgroundContent::Color(DARK_SUR)]).into())));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::TextColor(StyleTextColor { inner: DARK_INK }.into())));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BorderTopColor(StyleBorderTopColor { inner: DARK_BD }.into())));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BorderBottomColor(StyleBorderBottomColor { inner: DARK_BD }.into())));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BorderLeftColor(StyleBorderLeftColor { inner: DARK_BD }.into())));
    container_style.push(CssPropertyWithConditions::dark_theme(CssProperty::BorderRightColor(StyleBorderRightColor { inner: DARK_BD }.into())));
    ...
    label_style.push(CssPropertyWithConditions::dark_theme(CssProperty::TextColor(StyleTextColor { inner: DARK_INK }.into())));
...
const FLORA_DROPDOWN_WRAPPER_STYLE: &[CssPropertyWithConditions] = &[
    ...
    CssPropertyWithConditions::simple(CssProperty::const_padding_left(LayoutPaddingLeft::const_px(6))),
    CssPropertyWithConditions::simple(CssProperty::const_padding_right(LayoutPaddingRight::const_px(6))),
    CssPropertyWithConditions::simple(CssProperty::const_padding_top(LayoutPaddingTop::const_px(4))),
    CssPropertyWithConditions::simple(CssProperty::const_padding_bottom(LayoutPaddingBottom::const_px(4))),
    ...
    CssPropertyWithConditions::simple(CssProperty::const_background_content(StyleBackgroundContentVec::from_const_slice(&[StyleBackgroundContent::Color(LIGHT_SUR)]))),
    CssPropertyWithConditions::simple(CssProperty::const_text_color(StyleTextColor { inner: LIGHT_INK })),
    CssPropertyWithConditions::simple(CssProperty::const_border_top_color(StyleBorderTopColor { inner: LIGHT_BD })),
    CssPropertyWithConditions::simple(CssProperty::const_border_bottom_color(StyleBorderBottomColor { inner: LIGHT_BD })),
    CssPropertyWithConditions::simple(CssProperty::const_border_left_color(StyleBorderLeftColor { inner: LIGHT_BD })),
    CssPropertyWithConditions::simple(CssProperty::const_border_right_color(StyleBorderRightColor { inner: LIGHT_BD })),
    CssPropertyWithConditions::dark_theme(CssProperty::const_background_content(StyleBackgroundContentVec::from_const_slice(&[StyleBackgroundContent::Color(DARK_SUR)]))),
    CssPropertyWithConditions::dark_theme(CssProperty::const_text_color(StyleTextColor { inner: DARK_INK })),
    CssPropertyWithConditions::dark_theme(CssProperty::const_border_top_color(StyleBorderTopColor { inner: DARK_BD })),
    CssPropertyWithConditions::dark_theme(CssProperty::const_border_bottom_color(StyleBorderBottomColor { inner: DARK_BD })),
    CssPropertyWithConditions::dark_theme(CssProperty::const_border_left_color(StyleBorderLeftColor { inner: DARK_BD })),
    CssPropertyWithConditions::dark_theme(CssProperty::const_border_right_color(StyleBorderRightColor { inner: DARK_BD })),
];
...
pub fn drop_down(dd: crate::widgets::drop_down::DropDown) -> Dom {
    ...
    Dom::create_div()
        .with_css_props(CssPropertyWithConditionsVec::from_const_slice(FLORA_DROPDOWN_WRAPPER_STYLE))
        ...
        .with_children(DomVec::from_vec(vec![
            crate::widgets::widget_p()
                .with_css_props(CssPropertyWithConditionsVec::from_const_slice(FLORA_DROPDOWN_LABEL_STYLE))
                .with_children(DomVec::from_vec(vec![
            ...
            Dom::create_icon(AzString::from_const_str("arrow_drop_down"))
                .with_css_props(CssPropertyWithConditionsVec::from_const_slice(FLORA_DROPDOWN_ARROW_STYLE)),
        ]))
}
