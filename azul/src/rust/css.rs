    ...
    impl ColorU {
        ...
        pub fn from_str(string: String) -> Self { (crate::dll::get_azul_dll().az_color_u_from_str)(string) }
        /// Calls the `ColorU::to_hash` function.
        pub fn to_hash(&self)  -> crate::str::String { (crate::dll::get_azul_dll().az_color_u_to_hash)(self) }
    }
