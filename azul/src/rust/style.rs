    ...
    impl Clone for RectStyle { fn clone(&self) -> Self { crate::dll::az_rect_style_deep_copy(self) } }
    impl Drop for RectStyle { fn drop(&mut self) { crate::dll::az_rect_style_delete(self); } }


    /// `RectLayout` struct
    #[doc(inline)] pub use crate::dll::AzRectLayout as RectLayout;

    impl Clone for RectLayout { fn clone(&self) -> Self { crate::dll::az_rect_layout_deep_copy(self) } }
    impl Drop for RectLayout { fn drop(&mut self) { crate::dll::az_rect_layout_delete(self); } }
    ...
    impl Clone for CascadedCssPropertyWithSource { fn clone(&self) -> Self { crate::dll::az_cascaded_css_property_with_source_deep_copy(self) } }
    impl Drop for CascadedCssPropertyWithSource { fn drop(&mut self) { crate::dll::az_cascaded_css_property_with_source_delete(self); } }


    /// `CssPropertySource` struct
    #[doc(inline)] pub use crate::dll::AzCssPropertySource as CssPropertySource;

    impl Clone for CssPropertySource { fn clone(&self) -> Self { crate::dll::az_css_property_source_deep_copy(self) } }
    impl Drop for CssPropertySource { fn drop(&mut self) { crate::dll::az_css_property_source_delete(self); } }
    ...
    impl Clone for StyledNode { fn clone(&self) -> Self { crate::dll::az_styled_node_deep_copy(self) } }
    impl Drop for StyledNode { fn drop(&mut self) { crate::dll::az_styled_node_delete(self); } }
    ...
    impl Clone for ContentGroup { fn clone(&self) -> Self { crate::dll::az_content_group_deep_copy(self) } }
    impl Drop for ContentGroup { fn drop(&mut self) { crate::dll::az_content_group_delete(self); } }
    ...
    impl StyledDom {
        ...
        pub fn new(dom: Dom, css: Css) -> Self { crate::dll::az_styled_dom_new(dom, css) }
        /// Appends an already styled list of DOM nodes to the current `dom.root` - complexity `O(count(dom.dom_nodes))`
        pub fn append(&mut self, dom: StyledDom)  { crate::dll::az_styled_dom_append(self, dom) }
    }

    impl Clone for StyledDom { fn clone(&self) -> Self { crate::dll::az_styled_dom_deep_copy(self) } }
    impl Drop for StyledDom { fn drop(&mut self) { crate::dll::az_styled_dom_delete(self); } }
