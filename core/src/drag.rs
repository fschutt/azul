...
impl DragContext {
    ...
    pub fn calculate_scrollbar_scroll_offset(&self) -> Option<f32> {
        ...
        let mouse_delta = match drag.axis {
            ScrollbarAxis::Vertical => drag.current_mouse_position.y - drag.start_mouse_position.y,
        ...
        let thumb_length =
            (drag.viewport_length_px / drag.content_length_px) * drag.track_length_px;
