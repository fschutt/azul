...
impl<'a> CssBorderSideParseError<'a> {
    pub fn to_contained(&self) -> CssBorderSideParseErrorOwned {
        match self {
            CssBorderSideParseError::InvalidDeclaration(s) => CssBorderSideParseErrorOwned::InvalidDeclaration(s.to_string()),
            CssBorderSideParseError::Width(e) => CssBorderSideParseErrorOwned::Width(e.to_contained()),
            CssBorderSideParseError::Style(e) => CssBorderSideParseErrorOwned::Style(e.to_contained()),
            CssBorderSideParseError::Color(e) => CssBorderSideParseErrorOwned::Color(e.to_contained()),
        }
    }
}
...
impl CssBorderSideParseErrorOwned {
    pub fn to_shared<'a>(&'a self) -> CssBorderSideParseError<'a> {
        match self {
            CssBorderSideParseErrorOwned::InvalidDeclaration(s) => CssBorderSideParseError::InvalidDeclaration(s.as_str()),
...
#[cfg(feature="parser")]
pub fn parse_border_side<'a>(input: &'a str) -> Result<StyleBorderSide, CssBorderSideParseError<'a>> {
...
#[cfg(feature = "parser")]
pub fn parse_border_top_style<'a>(input: &'a str) -> Result<StyleBorderTopStyle, CssBorderStyleParseError<'a>> {
    parse_border_style(input).map(|inner| StyleBorderTopStyle { inner })
}
#[cfg(feature = "parser")]
pub fn parse_border_right_style<'a>(input: &'a str) -> Result<StyleBorderRightStyle, CssBorderStyleParseError<'a>> {
    parse_border_style(input).map(|inner| StyleBorderRightStyle { inner })
}
#[cfg(feature = "parser")]
pub fn parse_border_bottom_style<'a>(input: &'a str) -> Result<StyleBorderBottomStyle, CssBorderStyleParseError<'a>> {
    parse_border_style(input).map(|inner| StyleBorderBottomStyle { inner })
}
#[cfg(feature = "parser")]
pub fn parse_border_left_style<'a>(input: &'a str) -> Result<StyleBorderLeftStyle, CssBorderStyleParseError<'a>> {
    parse_border_style(input).map(|inner| StyleBorderLeftStyle { inner })
}

#[cfg(feature = "parser")]
pub fn parse_border_top_color<'a>(input: &'a str) -> Result<StyleBorderTopColor, CssColorParseError<'a>> {
    parse_css_color(input).map(|inner| StyleBorderTopColor { inner })
}
#[cfg(feature = "parser")]
pub fn parse_border_right_color<'a>(input: &'a str) -> Result<StyleBorderRightColor, CssColorParseError<'a>> {
    parse_css_color(input).map(|inner| StyleBorderRightColor { inner })
}
#[cfg(feature = "parser")]
pub fn parse_border_bottom_color<'a>(input: &'a str) -> Result<StyleBorderBottomColor, CssColorParseError<'a>> {
    parse_css_color(input).map(|inner| StyleBorderBottomColor { inner })
}
#[cfg(feature = "parser")]
pub fn parse_border_left_color<'a>(input: &'a str) -> Result<StyleBorderLeftColor, CssColorParseError<'a>> {
