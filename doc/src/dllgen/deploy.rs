...
fn generate_asset_li(version: &str, asset: &AssetInfo) -> String {
    if asset.is_present {
        ...
        // the wrong (placeholder) value. The description already names the asset.
        format!(
        ...
        <main>
          ...
          <div style='font-size:18px;'>
              ...
              <ul>
                ...
                <li><a href='https://github.com/fschutt/azul/releases/download/{version}/libazul-ios-arm64.a.tar.gz'>iOS arm64 (device)</a></li>
                <li><a href='https://github.com/fschutt/azul/releases/download/{version}/libazul-ios-sim-arm64.a.tar.gz'>iOS arm64 (simulator)</a></li>
              </ul>
