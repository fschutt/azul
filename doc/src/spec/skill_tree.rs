...
pub struct SkillNode {
    ...
    /// Whether this feature needs css/src/props/ files in agent context
    #[serde(default)]
    pub needs_css_source: bool,
    /// Whether this feature needs core/src/ files in agent context
    #[serde(default)]
    pub needs_core_source: bool,
    /// Verification status
    #[serde(default)]
...
impl SkillTree {
    pub fn new() -> Self {
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                difficulty: 1,
                depends_on: vec![],
                spec_urls: vec!["https://www.w3.org/TR/CSS22/box.html".to_string()],
                keywords: vec![
                    "content edge",
                    "padding edge",
                    "border edge",
                ...
                source_files: vec![
                    ...
                    "css/src/props/layout/spacing.rs".to_string(),
                ],
                source_functions: vec![],
                needs_text_engine: false,
                needs_css_source: true,
                needs_core_source: false,
                spec_sections: vec![
                    "8.1".to_string(),
                    "8.2".to_string(),
                    "8.3".to_string(),
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                .map(String::from)
                .collect(),
                source_files: vec!["layout/src/solver3/mod.rs".to_string()],
                source_functions: vec![],
                needs_text_engine: false,
                needs_css_source: false,
                needs_core_source: false,
                spec_sections: vec![],
                status: VerificationStatus::NotStarted,
                found_annotations: vec![],
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                source_files: vec![
                    ...
                    "css/src/props/layout/display.rs".to_string(),
                    "core/src/dom.rs".to_string(),
                ],
                source_functions: vec![],
                needs_text_engine: false,
                needs_css_source: true,
                needs_core_source: true,
                spec_sections: vec![],
                status: VerificationStatus::NotStarted,
                found_annotations: vec![],
            },
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                .map(String::from)
                .collect(),
                source_files: vec!["layout/src/solver3/fc.rs".to_string()],
                source_functions: vec![],
                needs_text_engine: false,
                needs_css_source: false,
                needs_core_source: false,
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                difficulty: 2,
                depends_on: vec!["box-model".to_string(), "display-property".to_string()],
                spec_urls: vec![
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                difficulty: 2,
                depends_on: vec!["box-model".to_string(), "containing-block".to_string()],
                spec_urls: vec![
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                source_files: vec![
                    ...
                    "css/src/props/style/text.rs".to_string(),
                ],
                source_functions: vec![],
                needs_text_engine: true,
                needs_css_source: true,
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                spec_urls: vec!["https://www.w3.org/TR/css-text-3/#line-breaking".to_string()],
                keywords: vec![
                    "line break",
                    "soft wrap",
                    "word-break",
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                difficulty: 3,
                depends_on: vec!["inline-formatting-context".to_string()],
                spec_urls: vec!["https://www.w3.org/TR/CSS22/visudet.html#line-height".to_string()],
                keywords: vec![
                    "line-height",
                    "vertical-align",
                    "leading",
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                spec_urls: vec!["https://www.w3.org/TR/css-sizing-3/".to_string()],
                keywords: vec![
                    "min-content",
                    "max-content",
                    "fit-content",
                ...
                .map(String::from)
                .collect(),
                source_files: vec!["layout/src/solver3/sizing.rs".to_string()],
                source_functions: vec![],
                needs_text_engine: true,
                needs_css_source: false,
                needs_core_source: false,
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                spec_urls: vec!["https://www.w3.org/TR/CSS22/visuren.html#floats".to_string()],
                keywords: vec![
                    "float",
                    "float: left",
                    "float: right",
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                source_files: vec![
                    "layout/src/solver3/fc.rs".to_string(),
                    "layout/src/solver3/getters.rs".to_string(),
                    "css/src/props/layout/overflow.rs".to_string(),
                ],
                source_functions: vec![],
                needs_text_engine: false,
                needs_css_source: true,
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                description: "box-sizing: border-box vs content-box width/height interpretation"
                    .to_string(),
                difficulty: 1,
                depends_on: vec!["box-model".to_string()],
                spec_urls: vec!["https://www.w3.org/TR/css-sizing-3/#box-sizing".to_string()],
                keywords: vec![
                    "box-sizing",
                    "border-box",
                    "content-box",
                ...
                source_files: vec![
                    "layout/src/solver3/sizing.rs".to_string(),
                    "layout/src/solver3/getters.rs".to_string(),
                    "css/src/props/layout/dimensions.rs".to_string(),
                ],
                source_functions: vec![],
                needs_text_engine: false,
                needs_css_source: true,
        ...
        nodes.insert(
            "font-metrics".to_string(),
            SkillNode {
                id: "font-metrics".to_string(),
                name: "Font Metrics".to_string(),
                description: "Ascender, descender, cap-height, x-height for baseline calculations"
                    .to_string(),
                difficulty: 3,
                depends_on: vec![
                    "inline-formatting-context".to_string(),
                ...
                spec_urls: vec!["https://www.w3.org/TR/css-inline-3/".to_string()],
                keywords: vec![
                    "ascent",
                    "descent",
                    "cap-height",
        ...
        nodes.insert(
            "text-alignment-spacing".to_string(),
            SkillNode {
                id: "text-alignment-spacing".to_string(),
                name: "Text Alignment & Spacing".to_string(),
                description: "text-align, letter-spacing, word-spacing in inline layout"
                    .to_string(),
                difficulty: 3,
                depends_on: vec!["inline-formatting-context".to_string()],
                spec_urls: vec![
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                difficulty: 4,
                depends_on: vec!["positioning".to_string()],
                spec_urls: vec![
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                difficulty: 4,
                depends_on: vec!["positioning".to_string(), "overflow".to_string()],
                spec_urls: vec!["https://www.w3.org/TR/css-position-3/#sticky-pos".to_string()],
                keywords: vec![
                    "sticky",
                    "position: sticky",
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                description: "display: contents — element generates no box, children promoted"
                    .to_string(),
                difficulty: 3,
                depends_on: vec!["display-property".to_string()],
                spec_urls: vec![
                ...
                .map(String::from)
                .collect(),
                source_files: vec!["layout/src/solver3/layout_tree.rs".to_string()],
                source_functions: vec![],
                needs_text_engine: false,
                needs_css_source: false,
                needs_core_source: false,
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                spec_urls: vec!["https://www.w3.org/TR/css-writing-modes-4/".to_string()],
                keywords: vec![
                    "writing-mode",
                    "direction",
                    "text-orientation",
        ...
        nodes.insert(
            ...
            SkillNode {
                ...
                spec_urls: vec!["https://www.w3.org/TR/CSS22/tables.html".to_string()],
                keywords: vec![
                    "table",
                    "table-row",
                    "table-cell",
    ...
    pub fn print_tree(&self) {
        ...
        for difficulty in 1..=5 {
            ...
            for node in nodes {
                ...
                println!("  {} {:30} {}", node.status.icon(), node.id, node.name);
        ...
        let not_started = self
            .nodes
            .values()
            .filter(|n| n.status == VerificationStatus::NotStarted)
            .count();
        let prompt_built = self
            .nodes
            .values()
            .filter(|n| n.status == VerificationStatus::PromptBuilt)
            .count();
        let prompt_sent = self
            .nodes
            .values()
            .filter(|n| matches!(n.status, VerificationStatus::PromptSent { .. }))
            .count();
        let implemented = self
            .nodes
            .values()
            .filter(|n| n.status == VerificationStatus::Implemented)
            .count();
        let verified = self
            .nodes
            .values()
    ...
    pub fn save_status(&self, path: &std::path::Path) -> std::io::Result<()> {
        let statuses: BTreeMap<&str, &VerificationStatus> = self
            .nodes
            .iter()
    ...
    pub fn load_with_status(path: &std::path::Path) -> Self {
        ...
        if let Ok(json) = std::fs::read_to_string(path) {
            if let Ok(statuses) =
                serde_json::from_str::<BTreeMap<String, VerificationStatus>>(&json)
            {
