...
impl ParagraphRegistry {
    pub fn new() -> Self {
        ...
        reg.add(
            "css22-box-8.3.1-p3",
            "Collapsing margins - empty boxes",
        ...
        reg.add(
            "css22-visudet-10.3.1-p1",
            "Inline non-replaced width",
        ...
        reg.add(
            "css22-visudet-10.3.5-p1",
            "Float non-replaced width",
            "Shrink-to-fit width",
            "css22-visudet.html",
            "10.3.5",
            1,
        ...
        reg.add(
            "css22-visudet-10.3.7-p1",
            "Abs pos non-replaced width",
        ...
        reg.add(
            "css22-visudet-10.3.8-p1",
            "Abs pos replaced width",
        ...
        reg.add(
            "css22-visudet-10.3.9-p1",
            "Inline-block non-replaced width",
        ...
        reg.add(
            "css22-visudet-10.6.1-p1",
            "Inline non-replaced height",
        ...
        reg.add(
            "css22-visudet-10.6.3-p1",
            "Block non-replaced height",
        ...
        reg.add(
            "css22-visudet-10.6.4-p1",
            "Abs pos non-replaced height",
        ...
        reg.add(
            "css22-visudet-10.6.7-p1",
            "Auto heights for BFC roots",
    ...
    pub fn find_annotations_in_file(
        &self,
        content: &str,
        file_path: &str,
            ...
            if let Some(start) = line.find("+spec:") {
                ...
                let end = rest
                    .find(|c: char| {
                        c.is_whitespace()
                            || c == '-'
                                && rest[..rest.find(c).unwrap_or(rest.len())]
                                    .matches('-')
                                    .count()
                                    >= 3
                    })
                ...
                let id_end = full_rest.find(" -").unwrap_or(
                    full_rest
                        .find(char::is_whitespace)
                        .unwrap_or(full_rest.len()),
                );
...
const DIRS_TO_SCAN: &[&str] = &["layout/src/solver3", "layout/src/text3"];
...
pub fn scan_spec_tags(azul_root: &std::path::Path) -> std::collections::HashSet<String> {
