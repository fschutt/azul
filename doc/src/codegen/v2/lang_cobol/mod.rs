...
fn emit_header(builder: &mut CodeBuilder) {
    ...
    builder.line("      *                                                                 *");
    builder.line("      * The -x flag produces an executable; -free enables free-format   *");
    builder.line("      * source so the column-7 indicator area is not required for       *");
    builder.line("      * caller code (this copybook itself uses fixed-format with the    *");
    builder.line("      * indicator area populated for maximum compatibility).            *");
    builder.line("      ******************************************************************");
    builder.blank();
}
