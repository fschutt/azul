...
fn emit_c_import(b: &mut CodeBuilder) {
    ...
    b.line("pub fn AzulRef(comptime T: type) type {");
    ...
    b.line("}");
    b.blank();
    b.line("/// Ergonomic string helper to hide `.ptr` and `.len` verbosity");
    b.line("pub inline fn azStr(s: []const u8) C.AzString {");
    b.line("    return C.AzString_fromUtf8(s.ptr, s.len);");
    b.line("}");
    b.blank();
    b.line("pub inline fn asAzStr(s: anytype) C.AzString {");
