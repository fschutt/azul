...
fn emit_c_import(b: &mut CodeBuilder) {
    ...
    b.line("            if (FirstArgT == C.AzRefAny) return user_fn(d, info);");
    b.line("            if (@typeInfo(FirstArgT) == .Pointer) {");
    ...
    b.line("                return user_fn(ptr.get(), info);");
    b.line("            }");
    b.line("            if (@hasDecl(FirstArgT, \"Model\")) {");
    b.line("                const InnerT = FirstArgT.Model;");
    b.line("                const ptr = ReflectModel(InnerT).downcast(&d) orelse return std.mem.zeroes(ReturnT);");
    b.line("                return user_fn(ptr, info);");
    b.line("            }");
    b.line("            return std.mem.zeroes(ReturnT);");
    b.line("        }");
    b.line("    }.wrapper;");
    b.line("}");
    b.blank();
