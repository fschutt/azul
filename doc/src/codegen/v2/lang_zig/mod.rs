...
fn emit_c_import(b: &mut CodeBuilder) {
    ...
    b.line("        // Zig guarantees a unique memory address for this global per instantiated type T");
    b.line("        var TYPE_TOKEN: u8 = 0;");
    b.line("");
    b.line("        pub fn typeId() u64 {");
    b.line("            return @intFromPtr(&TYPE_TOKEN);");
    b.line("        }");
    b.line("");
    b.line("        fn destructor(_: ?*anyopaque) callconv(.c) void {}");
    b.line("");
    b.line("        pub fn upcast(model: T) C.AzRefAny {");
    b.line("            var local = model; // Take a local copy to push to the Azul heap");
    b.line("            const name = @typeName(T);");
    b.line("            return C.AzRefAny_newC(");
    ...
    b.line("        }");
    b.line("");
    b.line("        pub fn downcast(refany: *const C.AzRefAny) ?*T {");
    b.line("            if (!C.AzRefAny_isType(refany, typeId())) return null;");
    b.line("            const ptr = C.AzRefAny_getDataPtr(refany) orelse return null;");
    b.line("            return @ptrCast(@constCast(@alignCast(ptr)));");
    b.line("        }");
    b.line("    };");
    b.line("}");
    b.blank();
