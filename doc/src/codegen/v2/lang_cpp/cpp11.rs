//! C++11 Generator
//!
//! This generator produces C++11-compatible code with proper move semantics.
//! Key features:
//!
//! - Real move constructors and move assignment operators
//! - noexcept specifier
//! - enum class support
...
impl CppDialect for Cpp11Generator {
    ...
    fn generate_method_implementations(
        ...
        // Constructor implementations (including Default)
        for func in ir
            .functions
            .iter()
