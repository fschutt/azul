...
//!
//! - `@_exported import CAzul` — re-exports the whole C surface, so any file compiled with
//!   `azul.swift` sees the `AzFoo` types and `Az*` functions directly (and external importers of
//!   the compiled module do too).
//! - Idiomatic procedure aliases without the `Az` prefix (`public let App_create = AzApp_create`),
//!   mirroring the Odin backend. The raw `Az*` symbols remain available through the imported
//!   module.
//!
...
pub fn module_map() -> String {
    format!(
        "// Auto-generated by azul-doc codegen v2 (lang_swift). DO NOT EDIT MANUALLY.\n// Exposes \
         the generated C header `azul.h` to Swift as the `{module}`\n// Clang module. \
         `azul.swift` does `@_exported import {module}`.\nmodule {module} {{\n\theader \
         \"azul.h\"\n\texport *\n}}\n",
