...
"#, name = prefixed_name, method = slice_method));
    ...
    // NOTE: Trait implementations (Clone, Debug, PartialEq, etc.) are now generated 
    // by struct_gen.rs based on custom_impls in api.json
    println!("      [IMPL] Generating String as_str() method...");
    dll_code.push_str("\n    // ===== String Methods =====\n\n");
