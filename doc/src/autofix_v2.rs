...
fn collect_all_api_types(api_data: &ApiData) -> HashMap<String, String> {
...
fn is_workspace_type(full_path: &str) -> bool {
...
fn collect_referenced_types_from_type_info(
...
fn infer_module_from_path(type_path: &str) -> String {
...
fn convert_type_info_to_class_patch(type_info: &ParsedTypeInfo) -> ClassPatch {
