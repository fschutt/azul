---
slug: internals/rendering/text-pipeline
title: Text Pipeline
language: en
canonical_slug: internals/rendering/text-pipeline
audience: contributor
maturity: wip
guide_order: null
topic_only: false
short_desc: Font discovery, parsing, and fallback chain resolution
prerequisites: [layout, compact-cache]
tracked_files:
  - layout/src/lib.rs
