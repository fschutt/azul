...
const STYLE_BACKGROUND_CONTENT_4857374953508308215_ITEMS: &[StyleBackgroundContent] = &[
    StyleBackgroundContent::LinearGradient(LinearGradient {
        ...
        stops: NormalizedLinearColorStopVec::from_const_slice(LINEAR_COLOR_STOP_8909964754681718371_ITEMS),
    })
];
...
const STYLE_BACKGROUND_CONTENT_16125239329823337131_ITEMS: &[StyleBackgroundContent] = &[
    StyleBackgroundContent::LinearGradient(LinearGradient {
        direction: Direction::FromTo(DirectionCorners { from: DirectionCorner::Top, to: DirectionCorner::Bottom }),
        extend_mode: ExtendMode::Clamp,
        stops: NormalizedLinearColorStopVec::from_const_slice(LINEAR_COLOR_STOP_8010235203234495977_ITEMS),
    })
];
...
const LINEAR_COLOR_STOP_8010235203234495977_ITEMS: &[NormalizedLinearColorStop] = &[
    NormalizedLinearColorStop { offset: PercentageValue::const_new(0), color: ColorU { r: 218, g: 236, b: 252, a: 255 } },
NormalizedLinearColorStop { offset: PercentageValue::const_new(100), color: ColorU { r: 196, g: 224, b: 252, a: 255 } }
];
const LINEAR_COLOR_STOP_8909964754681718371_ITEMS: &[NormalizedLinearColorStop] = &[
    NormalizedLinearColorStop { offset: PercentageValue::const_new(0), color: ColorU { r: 235, g: 244, b: 252, a: 255 } },
NormalizedLinearColorStop { offset: PercentageValue::const_new(100), color: ColorU { r: 220, g: 236, b: 252, a: 255 } }
];
...
const CSS_MATCH_10188117026223137249_PROPERTIES: &[NodeDataInlineCssProperty] = &[
    ...
    NodeDataInlineCssProperty::Focus(CssProperty::BorderBottomColor(StyleBorderBottomColorValue::Exact(StyleBorderBottomColor { inner: ColorU { r: 86, g: 157, b: 229, a: 255 } }))),
    NodeDataInlineCssProperty::Focus(CssProperty::BorderLeftColor(StyleBorderLeftColorValue::Exact(StyleBorderLeftColor { inner: ColorU { r: 86, g: 157, b: 229, a: 255 } }))),
    NodeDataInlineCssProperty::Focus(CssProperty::BorderRightColor(StyleBorderRightColorValue::Exact(StyleBorderRightColor { inner: ColorU { r: 86, g: 157, b: 229, a: 255 } }))),
    NodeDataInlineCssProperty::Focus(CssProperty::BorderTopColor(StyleBorderTopColorValue::Exact(StyleBorderTopColor { inner: ColorU { r: 86, g: 157, b: 229, a: 255 } }))),
    NodeDataInlineCssProperty::Focus(CssProperty::BackgroundContent(StyleBackgroundContentVecValue::Exact(StyleBackgroundContentVec::from_const_slice(STYLE_BACKGROUND_CONTENT_16125239329823337131_ITEMS)))),
    ...
    NodeDataInlineCssProperty::Active(CssProperty::BorderBottomColor(StyleBorderBottomColorValue::Exact(StyleBorderBottomColor { inner: ColorU { r: 86, g: 157, b: 229, a: 255 } }))),
    NodeDataInlineCssProperty::Active(CssProperty::BorderLeftColor(StyleBorderLeftColorValue::Exact(StyleBorderLeftColor { inner: ColorU { r: 86, g: 157, b: 229, a: 255 } }))),
    NodeDataInlineCssProperty::Active(CssProperty::BorderRightColor(StyleBorderRightColorValue::Exact(StyleBorderRightColor { inner: ColorU { r: 86, g: 157, b: 229, a: 255 } }))),
    NodeDataInlineCssProperty::Active(CssProperty::BorderTopColor(StyleBorderTopColorValue::Exact(StyleBorderTopColor { inner: ColorU { r: 86, g: 157, b: 229, a: 255 } }))),
    NodeDataInlineCssProperty::Active(CssProperty::BackgroundContent(StyleBackgroundContentVecValue::Exact(StyleBackgroundContentVec::from_const_slice(STYLE_BACKGROUND_CONTENT_16125239329823337131_ITEMS)))),
    ...
    NodeDataInlineCssProperty::Hover(CssProperty::BackgroundContent(StyleBackgroundContentVecValue::Exact(StyleBackgroundContentVec::from_const_slice(STYLE_BACKGROUND_CONTENT_4857374953508308215_ITEMS)))),
    ...
    NodeDataInlineCssProperty::Normal(CssProperty::MinWidth(LayoutMinWidthValue::Exact(LayoutMinWidth { inner: PixelValue::const_px(120) }))),
...
const CSS_MATCH_10188117026223137249: NodeDataInlineCssPropertyVec = NodeDataInlineCssPropertyVec::from_const_slice(CSS_MATCH_10188117026223137249_PROPERTIES);    
...
const CSS_MATCH_16432538576103237591: NodeDataInlineCssPropertyVec = NodeDataInlineCssPropertyVec::from_const_slice(CSS_MATCH_16432538576103237591_PROPERTIES);    
...
const CSS_MATCH_4428877324022630014: NodeDataInlineCssPropertyVec = NodeDataInlineCssPropertyVec::from_const_slice(CSS_MATCH_4428877324022630014_PROPERTIES);    
...
const CSS_MATCH_4687758758634879229: NodeDataInlineCssPropertyVec = NodeDataInlineCssPropertyVec::from_const_slice(CSS_MATCH_4687758758634879229_PROPERTIES);    
...
const CSS_MATCH_5369484915686807864_PROPERTIES: &[NodeDataInlineCssProperty] = &[
    ...
    NodeDataInlineCssProperty::Normal(CssProperty::Transform(StyleTransformVecValue::Exact(StyleTransformVec::from_const_slice(STYLE_TRANSFORM_9499236770162623295_ITEMS)))),
    NodeDataInlineCssProperty::Normal(CssProperty::Height(LayoutHeightValue::Exact(LayoutHeight { inner: PixelValue::const_px(6) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderLeftWidth(LayoutBorderLeftWidthValue::Exact(LayoutBorderLeftWidth { inner: PixelValue::const_px(2) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderLeftStyle(StyleBorderLeftStyleValue::Exact(StyleBorderLeftStyle { inner: BorderStyle::Solid }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderLeftColor(StyleBorderLeftColorValue::Exact(StyleBorderLeftColor { inner: ColorU { r: 96, g: 96, b: 96, a: 255 } }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderBottomWidth(LayoutBorderBottomWidthValue::Exact(LayoutBorderBottomWidth { inner: PixelValue::const_px(2) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderBottomStyle(StyleBorderBottomStyleValue::Exact(StyleBorderBottomStyle { inner: BorderStyle::Solid }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderBottomColor(StyleBorderBottomColorValue::Exact(StyleBorderBottomColor { inner: ColorU { r: 96, g: 96, b: 96, a: 255 } })))
];
const CSS_MATCH_5369484915686807864: NodeDataInlineCssPropertyVec = NodeDataInlineCssPropertyVec::from_const_slice(CSS_MATCH_5369484915686807864_PROPERTIES);    

const CSS_MATCH_6763840958685503000_PROPERTIES: &[NodeDataInlineCssProperty] = &[
    // .__azul-native-dropdown-arrow
    NodeDataInlineCssProperty::Normal(CssProperty::MinWidth(LayoutMinWidthValue::Exact(LayoutMinWidth { inner: PixelValue::const_px(20) }))),
...
const CSS_MATCH_6763840958685503000: NodeDataInlineCssPropertyVec = NodeDataInlineCssPropertyVec::from_const_slice(CSS_MATCH_6763840958685503000_PROPERTIES);    
...
const CSS_MATCH_7938442083662451131_PROPERTIES: &[NodeDataInlineCssProperty] = &[
    ...
    NodeDataInlineCssProperty::Hover(CssProperty::BorderBottomColor(StyleBorderBottomColorValue::Exact(StyleBorderBottomColor { inner: ColorU { r: 0, g: 0, b: 0, a: 255 } }))),
    NodeDataInlineCssProperty::Hover(CssProperty::BorderLeftColor(StyleBorderLeftColorValue::Exact(StyleBorderLeftColor { inner: ColorU { r: 0, g: 0, b: 0, a: 255 } }))),
    NodeDataInlineCssProperty::Hover(CssProperty::BorderRightColor(StyleBorderRightColorValue::Exact(StyleBorderRightColor { inner: ColorU { r: 0, g: 0, b: 0, a: 255 } }))),
    NodeDataInlineCssProperty::Hover(CssProperty::BorderTopColor(StyleBorderTopColorValue::Exact(StyleBorderTopColor { inner: ColorU { r: 0, g: 0, b: 0, a: 255 } }))),
    // .__azul-native-dropdown-focused-text
    NodeDataInlineCssProperty::Normal(CssProperty::PaddingRight(LayoutPaddingRightValue::Exact(LayoutPaddingRight { inner: PixelValue::const_px(15) }))),
    ...
    NodeDataInlineCssProperty::Normal(CssProperty::BorderBottomRightRadius(StyleBorderBottomRightRadiusValue::Exact(StyleBorderBottomRightRadius { inner: PixelValue::const_px(2) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderBottomLeftRadius(StyleBorderBottomLeftRadiusValue::Exact(StyleBorderBottomLeftRadius { inner: PixelValue::const_px(2) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderTopRightRadius(StyleBorderTopRightRadiusValue::Exact(StyleBorderTopRightRadius { inner: PixelValue::const_px(2) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderTopLeftRadius(StyleBorderTopLeftRadiusValue::Exact(StyleBorderTopLeftRadius { inner: PixelValue::const_px(2) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderBottomWidth(LayoutBorderBottomWidthValue::Exact(LayoutBorderBottomWidth { inner: PixelValue::const_px(1) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderLeftWidth(LayoutBorderLeftWidthValue::Exact(LayoutBorderLeftWidth { inner: PixelValue::const_px(1) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderRightWidth(LayoutBorderRightWidthValue::Exact(LayoutBorderRightWidth { inner: PixelValue::const_px(1) }))),
    NodeDataInlineCssProperty::Normal(CssProperty::BorderTopWidth(LayoutBorderTopWidthValue::Exact(LayoutBorderTopWidth { inner: PixelValue::const_px(1) }))),
...
const CSS_MATCH_7938442083662451131: NodeDataInlineCssPropertyVec = NodeDataInlineCssPropertyVec::from_const_slice(CSS_MATCH_7938442083662451131_PROPERTIES);


pub type DropDownOnChoiceChangeCallbackType = extern "C" fn(&mut RefAny, &mut CallbackInfo, usize) -> Update;
impl_callback!(DropDownOnChoiceChange, OptionDropDownOnChoiceChange, DropDownOnChoiceChangeCallback, DropDownOnChoiceChangeCallbackType);
...
impl DropDown {
    ...
    pub fn dom(self) -> Dom {
        ...
        .with_children(DomVec::from_vec(vec![
            ...
            .with_ids_and_classes({
                const IDS_AND_CLASSES_6395608618544226348: &[IdOrClass] = &[
                    Class(AzString::from_const_str("__azul-native-dropdown-wrapper")),
                ];
            ...
            .with_callbacks(vec![
                CallbackData {
                    ...
                    data: data.clone(),
                    callback: Callback { cb: on_dropdown_click },
                }
            ].into())
            .with_children(DomVec::from_vec(vec![
                Dom::div()
                ...
                .with_ids_and_classes({
                    const IDS_AND_CLASSES_11862789041977911489: &[IdOrClass] = &[
                        Class(AzString::from_const_str("__azul-native-dropdown-focused-text")),
                    ];
                ...
                .with_ids_and_classes({
                    const IDS_AND_CLASSES_17649077225810153180: &[IdOrClass] = &[
                        Class(AzString::from_const_str("__azul-native-dropdown-arrow")),
                    ];
                ...
                .with_children(DomVec::from_vec(vec![
                    ...
                    .with_ids_and_classes({
                        const IDS_AND_CLASSES_17777388057004109464: &[IdOrClass] = &[
                            Class(AzString::from_const_str("__azul-native-dropdown-arrow-wrapper")),
                        ];
                    ...
                    .with_children(DomVec::from_vec(vec![
                        ...
                        .with_ids_and_classes({
                            const IDS_AND_CLASSES_12603885741328163120: &[IdOrClass] = &[
                                Class(AzString::from_const_str("__azul-native-dropdown-arrow-content")),
                            ];
                            IdOrClassVec::from_const_slice(IDS_AND_CLASSES_12603885741328163120)
                        })
                    ]))
                ]))
            ]))
...
extern "C"
fn on_dropdown_click(data: &mut RefAny, info: &mut CallbackInfo) -> Update {
    ...
    #[cfg(target_os = "windows")] {
        ...
        child_window_state.platform_specific_options.windows_options.parent_window = raw_window_handle;
    }
...
fn dropdownWindowLayoutFn(data: &mut RefAny, _: &mut RefAny, info: &mut LayoutCallbackInfo) -> StyledDom {
    ...
    dropdown_local_dataset.choices.iter().enumerate().map(|(choice_id, choice)| {
        ...
        .with_callbacks(vec![
            CallbackData {
                ...
                callback: Callback { cb: on_choice_change }
            }
        ].into())
    })
    .collect::<Dom>()
...
extern "C"
fn on_choice_change(data: &mut RefAny, info: &mut CallbackInfo) -> Update {
...
extern "C"
fn close_choice_window(_: &mut RefAny, info: &mut CallbackInfo) -> Update {
