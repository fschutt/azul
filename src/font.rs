...
pub mod parsed {
    ...
    /// implemented on this platform") — every `last_used` store on a font
    /// touch aborted the module. LRU eviction only needs *ordering*, not
    /// wall time; an atomic counter is exactly as monotonic.
