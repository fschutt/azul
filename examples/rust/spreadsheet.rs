...
pub mod components {
    ...
    pub mod body {
        use azul::{dom::Dom, str::String as AzString};
        #[inline]
        pub fn render() -> Dom {
            Dom::body()
        }
...
pub mod ui {
    ...
    use azul::{
        ...
        vec::{
            ...
            NormalizedRadialColorStopVec, StyleBackgroundContentVec, StyleBackgroundPositionVec,
            StyleBackgroundRepeatVec, StyleBackgroundSizeVec, StyleFontFamilyVec,
            StyleTransformVec,
        },
    };
    ...
    const CSS_MATCH_14701061083766788292_PROPERTIES: &[NodeDataInlineCssProperty] = &[
        ...
        NodeDataInlineCssProperty::Normal(CssProperty::AlignContent(
            LayoutAlignContentValue::Exact(LayoutAlignContent::Center),
        )),
    ];
    ...
    pub fn render() -> Dom {
        Dom::body().with_children(DomVec::from_vec(vec![
            div::render()
                        ...
                        .with_children(DomVec::from_vec(vec![
                            p::render(AzString::from_const_str("FILE"))
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_4826288409200248071,
                                    )
                                }),
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_9410866575549354381,
                                    )
                                }),
                            p::render(AzString::from_const_str("HOME"))
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_8715430661028246044,
                                    )
                                }),
                            ...
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_16912306910777040419,
                                    )
                                }),
                        ])),
                    div::render()
                        ...
                        .with_children(DomVec::from_vec(vec![
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_10025392060247617630,
                                    )
                                })
                                .with_children(DomVec::from_vec(vec![
                                    div::render()
                                        ...
                                        .with_ids_and_classes({
                                            const IDS_AND_CLASSES_2004408468416758999:
...
IdOrClassVec::from_const_slice(IDS_AND_CLASSES_638783468819161744)
                                    ...
                                    p::render(AzString::from_const_str("Clipboard"))
                                        ...
                                        .with_ids_and_classes({
                                            const IDS_AND_CLASSES_6233255149722984275:
                                                &[IdOrClass] = &[Class(AzString::from_const_str(
                                                "__azul_native-ribbon-section-name",
                                            ))];
                                            IdOrClassVec::from_const_slice(
                            ...
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_16234433965518568113,
                                    )
                                })
                                .with_children(DomVec::from_vec(vec![
                                    div::render()
                                        ...
                                        .with_children(DomVec::from_vec(vec![p::render(
                            ...
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_8769206706192203364,
                                    )
                                })
                                .with_children(DomVec::from_vec(vec![
                                    div::render()
                            ...
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_8980483043948686304,
                                    )
                                })
                                .with_children(DomVec::from_vec(vec![
                                    div::render()
                            ...
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_6781594546968350058,
                                    )
                                })
                                .with_children(DomVec::from_vec(vec![
                                    div::render()
                            ...
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_11618651107626783359,
                                    )
                                })
                                .with_children(DomVec::from_vec(vec![
                                    div::render()
                            ...
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_4188199152450384868,
                                    )
                                })
                                .with_children(DomVec::from_vec(vec![
                                    div::render()
                        ...
                        .with_children(DomVec::from_vec(vec![
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_11934605447595340819,
                                    )
                                }),
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_8641031272598022019,
                                    )
                                }),
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_8760623635179493498,
                                    )
                                }),
                        ])),
                    div::render()
                        ...
                        .with_children(DomVec::from_vec(vec![
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_11138594709704370127,
                                    )
                                })
                                .with_children(DomVec::from_vec(vec![p::render(
                                    AzString::from_const_str("=C3+D3"),
                                )])),
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_4858486846847064360,
                                    )
                                }),
                        ])),
                ])),
            div::render()
                ...
                .with_children(DomVec::from_vec(vec![
                        ...
                        .with_children(DomVec::from_vec(vec![
                            div::render()
                                ...
                                .with_ids_and_classes({
                                    ...
                                    IdOrClassVec::from_const_slice(
                                        IDS_AND_CLASSES_9015622857980542987,
                                    )
                                }),
                    ...
                    div::render()
                        ...
                        .with_children(DomVec::from_vec(vec![div::render()
...
extern "C" fn render(_: &mut RefAny, _: &mut LayoutCallbackInfo) -> StyledDom {
    crate::ui::render().style(Css::empty()) // styles are applied inline
}
