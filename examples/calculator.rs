...
impl Layout for Calculator {
    fn layout(&self, _info: WindowInfo<Self>) -> Dom<Self> {
        Dom::new(NodeType::Div)
            .with_child(Dom::new(NodeType::Div).with_id("result")
                .with_child(Dom::new(NodeType::Label(
            ...
            .with_child(Dom::new(NodeType::Div).with_id("numpad-container")
                .with_child(Dom::new(NodeType::Div).with_class("row").with_hit_test(On::MouseUp)
                    .with_child(Dom::new(NodeType::label("C")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("+/-")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("%")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("/")).with_class("orange").with_hit_test(On::MouseUp))
                )
                .with_child(Dom::new(NodeType::Div).with_class("row").with_hit_test(On::MouseUp)
                    .with_child(Dom::new(NodeType::label("7")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("8")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("9")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("x")).with_class("orange").with_hit_test(On::MouseUp))
                )
                .with_child(Dom::new(NodeType::Div).with_class("row").with_hit_test(On::MouseUp)
                    .with_child(Dom::new(NodeType::label("4")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("5")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("6")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("-")).with_class("orange").with_hit_test(On::MouseUp))
                )
                .with_child(Dom::new(NodeType::Div).with_class("row").with_hit_test(On::MouseUp)
                    .with_child(Dom::new(NodeType::label("1")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("2")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("3")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("+")).with_class("orange").with_hit_test(On::MouseUp))
                )
                .with_child(Dom::new(NodeType::Div).with_class("row").with_hit_test(On::MouseUp)
                    .with_child(Dom::new(NodeType::label("0")).with_id("zero").with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label(".")).with_class("numpad-button").with_hit_test(On::MouseUp))
                    .with_child(Dom::new(NodeType::label("=")).with_class("orange").with_hit_test(On::MouseUp))
                )
