...
============================================================================
KNOWN BLOCKER (2026-05-28): this example CANNOT currently pass under AZ_E2E.
The pyo3 binding (cargo feature `python-extension`, generated by
doc/src/codegen/v2/lang_python.rs) is missing the API needed to build and run
this app. See the bottom of this file / the session report for the full
diagnosis. The code below is the *intended* program (the regression target once
the binding is fixed); it is NOT faked to print success.
============================================================================
"""
