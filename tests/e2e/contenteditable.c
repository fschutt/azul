...
const char* CSS_STYLE = 
    ...
    "    padding: 20px; \n"
    "    background-color: #102030; /* COLORFUL: body = dark slate */ \n"
    ...
    "    font-size: 32px;\n"
    "    color: #000000;\n"
    "    background-color: #cc6600; /* COLORFUL: labels = orange */\n"
    "    margin-bottom: 10px;\n"
    "    margin-top: 20px;\n"
    "}\n"
    "\n"
    ...
    "    font-size: 48px;\n"
    "    padding: 20px;\n"
    "    background-color: #225522; /* COLORFUL: single-input = green */\n"
    "    color: #ffffff;\n"
    ...
    "    font-size: 48px;\n"
    "    padding: 20px;\n"
    "    background-color: #222266; /* COLORFUL: textarea = blue */\n"
    "    color: #ffffff;\n"
    "    border: 3px solid #555555;\n"
    "    min-height: 300px;\n"
    "    max-height: 400px;\n"
    ...
    "    margin-top: 20px;\n"
    "    padding: 10px;\n"
    "    background-color: #662222; /* COLORFUL: status = red */\n"
    "}\n"
    "\n"
