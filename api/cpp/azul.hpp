...
using AzThreadCallbackType = void(*)(AzRefAny, AzThreadSender, AzThreadReceiver);

using AzRefAnyDestructorType = void(*)(void*);

using AzTimerCallbackType = AzTimerCallbackReturn(*)(AzRefAny*, AzRefAny*, AzTimerCallbackInfo);

using AzLayoutCallbackType = AzStyledDom(*)(AzRefAny*, AzLayoutInfo);
