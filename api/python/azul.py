...
cdef extern from *:
  ...
  ctypedef void (*AzThreadCallbackType)(AzRefAny, AzThreadSender, AzThreadReceiver);

  ctypedef void (*AzRefAnyDestructorType)(void*);

  ctypedef AzTimerCallbackReturn (*AzTimerCallbackType)(AzRefAny*, AzRefAny*, AzTimerCallbackInfo);

  ctypedef AzStyledDom (*AzLayoutCallbackType)(AzRefAny*, AzLayoutInfo);
  ...
  AzAppConfig az_app_config_default();
  ...
  void az_callback_info_create_window(AzCallbackInfo *callbackinfo,
                                      AzWindowCreateOptions new_window);
  ...
  void az_callback_info_set_window_state(AzCallbackInfo *callbackinfo,
                                         AzWindowState new_state);
  ...
  uint32_t az_gl_context_ptr_create_shader(const AzGlContextPtr *glcontextptr,
  ...
  void az_gl_context_ptr_delete_textures(const AzGlContextPtr *glcontextptr,
                                         AzGLuintVecRef textures);
  ...
  AzString az_gl_context_ptr_get_shader_info_log(const AzGlContextPtr *glcontextptr,
                                                 uint32_t shader);
  ...
  uint8_t az_gl_context_ptr_is_framebuffer(const AzGlContextPtr *glcontextptr,
                                           uint32_t framebuffer);
  ...
  void az_gl_context_ptr_push_group_marker_ext(const AzGlContextPtr *glcontextptr,
                                               AzRefstr message);
  ...
  void az_gl_context_ptr_uniform_1i(const AzGlContextPtr *glcontextptr,
                                    int32_t location,
                                    int32_t v0);
  ...
  AzSvgParseOptions az_svg_parse_options_default();
  ...
  AzSvgRenderOptions az_svg_render_options_default();
  ...
  AzTextureFlags az_texture_flags_default();
  ...
  AzWindowState az_window_state_default();
