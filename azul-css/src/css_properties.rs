...
impl CssProperty {
    pub fn key(&self) -> &'static str {
        match self {
            CssProperty::TextColor(_) => "color",
            CssProperty::FontSize(_) => "font-size",
            CssProperty::FontFamily(_) => "font-family",
            CssProperty::TextAlign(_) => "text-align",
            CssProperty::LetterSpacing(_) => "letter-spacing",
            CssProperty::LineHeight(_) => "line-height",
            CssProperty::WordSpacing(_) => "word-spacing",
            CssProperty::TabWidth(_) => "tab-width",
            CssProperty::Cursor(_) => "cursor",
            CssProperty::Display(_) => "display",
            CssProperty::Float(_) => "float",
            CssProperty::BoxSizing(_) => "box-sizing",
            CssProperty::Width(_) => "width",
            CssProperty::Height(_) => "height",
            CssProperty::MinWidth(_) => "min-width",
            CssProperty::MinHeight(_) => "min-height",
            CssProperty::MaxWidth(_) => "max-width",
            CssProperty::MaxHeight(_) => "max-height",
            CssProperty::Position(_) => "position",
            CssProperty::Top(_) => "top",
            CssProperty::Right(_) => "right",
            CssProperty::Left(_) => "left",
            CssProperty::Bottom(_) => "bottom",
            CssProperty::FlexWrap(_) => "flex-wrap",
            CssProperty::FlexDirection(_) => "flex-direction",
            CssProperty::FlexGrow(_) => "flex-grow",
            CssProperty::FlexShrink(_) => "flex-shrink",
            CssProperty::JustifyContent(_) => "justify-content",
            CssProperty::AlignItems(_) => "align-items",
            CssProperty::AlignContent(_) => "align-content",
            CssProperty::BackgroundContent(_) => "background-content",
            CssProperty::BackgroundPosition(_) => "background-position",
            CssProperty::BackgroundSize(_) => "background-size",
            CssProperty::BackgroundRepeat(_) => "background-repeat",
            CssProperty::OverflowX(_) => "overflow-x",
            CssProperty::OverflowY(_) => "overflow-y",
            CssProperty::PaddingTop(_) => "padding-top",
            CssProperty::PaddingLeft(_) => "padding-left",
            CssProperty::PaddingRight(_) => "padding-right",
            CssProperty::PaddingBottom(_) => "padding-bottom",
            CssProperty::MarginTop(_) => "margin-top",
            CssProperty::MarginLeft(_) => "margin-left",
            CssProperty::MarginRight(_) => "margin-right",
            CssProperty::MarginBottom(_) => "margin-bottom",
            CssProperty::BorderTopLeftRadius(_) => "border-top-left-radius",
            CssProperty::BorderTopRightRadius(_) => "border-top-right-radius",
            CssProperty::BorderBottomLeftRadius(_) => "border-bottom-left-radius",
            CssProperty::BorderBottomRightRadius(_) => "border-bottom-right-radius",
            CssProperty::BorderTopColor(_) => "border-top-color",
            CssProperty::BorderRightColor(_) => "border-right-color",
            CssProperty::BorderLeftColor(_) => "border-left-color",
            CssProperty::BorderBottomColor(_) => "border-bottom-color",
            CssProperty::BorderTopStyle(_) => "border-top-style",
            CssProperty::BorderRightStyle(_) => "border-right-style",
            CssProperty::BorderLeftStyle(_) => "border-left-style",
            CssProperty::BorderBottomStyle(_) => "border-bottom-style",
            CssProperty::BorderTopWidth(_) => "border-top-width",
            CssProperty::BorderRightWidth(_) => "border-right-width",
            CssProperty::BorderLeftWidth(_) => "border-left-width",
            CssProperty::BorderBottomWidth(_) => "border-bottom-width",
            CssProperty::BoxShadowLeft(_) => "-azul-box-shadow-left",
            CssProperty::BoxShadowRight(_) => "-azul-box-shadow-right",
            CssProperty::BoxShadowTop(_) => "-azul-box-shadow-top",
            CssProperty::BoxShadowBottom(_) => "-azul-box-shadow-bottom",
            CssProperty::ScrollbarStyle(_) => "-azul-scrollbar-style",
            CssProperty::Opacity(_) => "opacity",
            CssProperty::Transform(_) => "transform",
            CssProperty::TransformOrigin(_) => "transform-origin",
            CssProperty::PerspectiveOrigin(_) => "perspective-origin",
            CssProperty::BackfaceVisibility(_) => "backface-visibility",
        }
    }
